...
public interface InvoiceProjectRepository extends JpaRepository<InvoiceProject, Long> {
     ...
     * @return
     */
    Optional<InvoiceProject> findByProjectId(String projectId);

    /**
     * 删除
     * @param id
     */
    @Query("update InvoiceProject i set i.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where i.projectId = :id")
    @Modifying
