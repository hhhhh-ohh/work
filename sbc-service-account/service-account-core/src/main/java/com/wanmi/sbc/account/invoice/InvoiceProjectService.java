...
public class InvoiceProjectService {
     ...
     * @return
     */
    public Optional<InvoiceProject> findAllInvoiceProjectById(String projcetId){
        return invoiceProjectRepository.findByProjectId(projcetId);
    }
    ...
    public InvoiceProject saveInvoiceProject(InvoiceProjectSaveRequest invoiceProjectSaveRequest){
        ...
        if(invoiceProjectIsExist(projectName, invoiceProjectSaveRequest.getCompanyInfoId())){
            throw new SbcRuntimeException(AccountErrorCodeEnum.K020003);
        }
    ...
    public InvoiceProject editInvoiceProject(InvoiceProjectSaveRequest invoiceProjectSaveRequest){
        ...
        InvoiceProject invProject = invoiceProject.orElseThrow(() -> new SbcRuntimeException(CommonErrorCodeEnum.K000009));
