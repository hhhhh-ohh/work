...
public class Settlement implements Serializable {
    ...
    private static final long serialVersionUID = -4492284192499819436L;
    /**
     ...
     * 总供货运费
     */
    @Column(name = "third_plat_form_freight")
     ...
     * 礼品卡-提货卡抵扣金额
     */
    @Column(name = "pickup_gift_card_price")
    private BigDecimal pickupGiftCardPrice;

    /**
     * 社区团购佣金
     */
    @Column(name = "community_commission_price")
