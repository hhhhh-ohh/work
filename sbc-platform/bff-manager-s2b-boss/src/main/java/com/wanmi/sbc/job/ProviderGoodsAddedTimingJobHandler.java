...
@Component
@Slf4j
public class ProviderGoodsAddedTimingJobHandler {
    ...
    @XxlJob(value = "providerGoodsAddedTimingJobHandler")
    public void execute() throws Exception {
        ...
        goodsStockService.providerGoodsAdded(goodsPages.getContent(), AddedFlag.YES);
        ...
        for (int i = 1; i < pageCount; i++) {
            ...
            if (CollectionUtils.isNotEmpty(tmpGoodsPages.getContent())) {
                goodsStockService.providerGoodsAdded(tmpGoodsPages.getContent(), AddedFlag.YES);
            }
        }
    }
}
