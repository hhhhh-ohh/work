 ...
 * 废弃--后期用素材库代替
 */
@Tag(name = "ImageCateController", description = "图片分类服务 Api")
@RestController
@Validated
public class ImageCateController {
     ...
     * 检测图片分类是否有子类图片
     */
    @Operation(summary = "检测图片分类是否有子类图片")
    ...
    @Parameter(name = "cateId", description = "图片分类id", required = true)
