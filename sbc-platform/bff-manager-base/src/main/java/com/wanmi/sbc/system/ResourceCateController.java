 ...
 */
@Tag(name = "ResourceCateController", description = "素材分类服务 Api")
@RestController
@Validated
public class ResourceCateController {
     ...
     * 检测素材分类是否有子类素材
     */
    @Operation(summary = "检测素材分类是否有子类素材")
