...
public class TradeController {
    ...
    public BaseResponse<MicroServicePage<TradeVO>> supplierPage(@RequestBody TradeQueryDTO tradeQueryRequest) {
        ...
        tradeQueryRequest.setSupplierId(commonUtil.getCompanyInfoId());

        if (tradeQueryRequest.getIsNotBoss()) {
            if (tradeQueryRequest.getTradeState() != null && tradeQueryRequest.getTradeState().getPayState() != null) {
                tradeQueryRequest.setNotFlowStates(Arrays.asList(FlowState.VOID, FlowState.INIT));
            }
        }
        ...
        TradePageCriteriaRequest tradePageCriteriaRequest = TradePageCriteriaRequest.builder().tradePageDTO(tradeQueryRequest).build();
        MicroServicePage<TradeVO> tradePage = tradeQueryProvider.supplierPageCriteria(tradePageCriteriaRequest).getContext().getTradePage();
...
//            }
    ...
    public BaseResponse<MicroServicePage<TradeVO>> bossPage(@RequestBody TradeQueryDTO tradeQueryRequest) {
        ...
        tradeQueryRequest.setCrossBorderFlag(false);
        TradePageCriteriaRequest tradePageCriteriaRequest = TradePageCriteriaRequest.builder().tradePageDTO(tradeQueryRequest).build();
        MicroServicePage<TradeVO> tradePage = tradeQueryProvider.pageBossCriteria(tradePageCriteriaRequest).getContext().getTradePage();
