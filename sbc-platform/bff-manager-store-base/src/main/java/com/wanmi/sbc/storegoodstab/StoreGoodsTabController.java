 ...
 */
@Tag(name = "StoreGoodsTabController", description = "商品详情模板管理服务API")
@RestController
@Validated
...
public class StoreGoodsTabController {
     ...
     * 查询商家商品详情模板List
     */
    @Operation(summary = "查询商家商品详情模板List")
     ...
     * 删除店铺商品详情模板
     */
    @Operation(summary = "删除店铺商品详情模板")
    @Parameter(name = "tabId", description = "模板Id", required = true)
