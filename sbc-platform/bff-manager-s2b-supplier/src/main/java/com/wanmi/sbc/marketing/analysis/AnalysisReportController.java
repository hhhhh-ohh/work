...
public class AnalysisReportController {
     ...
     * @return
     */
    @Operation(summary = "营销概览-营销概况和效果分析")
    @PostMapping(value = "/all/overview")
    public BaseResponse<MarketingAnalysisBase> marketingOverview(@RequestBody MarketingOverviewRequest request){
        request.setStoreId(commonUtil.getStoreId());
        MarketingAnalysisBase overview = marketingAnalysisProvider.marketingOverview(request);
        if (Objects.isNull(overview)){
            overview = new MarketingOverview();
            overview.init();
        }
     ...
     * @return
     */
    @Operation(summary = "营销概览-数据趋势")
    @PostMapping(value = "/all/overviewForTrendChart")
    public BaseResponse<List<? extends MarketingAnalysisBase>> trendChartOfOverview(@RequestBody MarketingOverviewRequest request){
        request.setStoreId(commonUtil.getStoreId());
        List<? extends MarketingAnalysisBase> list = marketingAnalysisProvider.getTrendChartForMarketingOverview(request);
     ...
     * @return
     */
    @Operation(summary = "营销概览-支付金额趋势")
    @PostMapping(value = "/all/moneyForTrendChart")
    public BaseResponse<List<? extends MarketingAnalysisBase>> trendChartOfMoney(@RequestBody MarketingOverviewRequest request){
        request.setStoreId(commonUtil.getStoreId());
        List<? extends MarketingAnalysisBase> list = marketingAnalysisProvider.getTrendChartForMoney(request);
        return BaseResponse.success(list);
    }
     ...
     * @return
     */
    @Operation(summary = "营销概览- 活动数据概况")
    @PostMapping(value = "/data/situation")
    public BaseResponse<List<? extends MarketingAnalysisBase>> marketingDataSituation(@RequestBody MarketingOverviewRequest request){
        request.setStoreId(commonUtil.getStoreId());
        List<? extends MarketingAnalysisBase> list = marketingAnalysisProvider.getMarketingDataSituation(request);
        return BaseResponse.success(list);
    }
    ...
    public BaseResponse<List<? extends MarketingAnalysisBase>> getOverviewForTrendChart(@RequestBody MarketingQueryRequest request){
        ...
        if(CollectionUtils.isNotEmpty(analysisOverviews)){
    ...
    public BaseResponse<PageInfo<? extends MarketingAnalysisBase>> marketingActivityEffect(@RequestBody EffectPageRequest request){
        request.setStoreId(commonUtil.getStoreId());
