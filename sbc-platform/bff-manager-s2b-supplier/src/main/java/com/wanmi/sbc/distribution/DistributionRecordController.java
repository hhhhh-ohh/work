...
public class DistributionRecordController {
    ...
    public BaseResponse<EsDistributionRecordPageResponse> page(@RequestBody @Valid EsDistributionRecordPageRequest distributionRecordPageRequest){
        ...
        distributionRecordPageRequest.setStoreId(commonUtil.getStoreId());
     ...
     * @return
     */
    @Operation(summary = "根据名称模糊查询店铺信息")
     ...
     * @return
     */
    @Operation(summary = "根据编码模糊查询company信息")
     ...
     * @return
     */
    @Operation(summary = "根据会员的名称或账号模糊查询会员信息")
     ...
     * @return
     */
    @Operation(summary = "根据商品的名称和编码模糊查询商品信息")
    ...
    /**
     * todo--根据分销员账号或名称联想会员信息
     */
    @Operation(summary = "根据分销员账号或名称联想会员信息")
    @RequestMapping(value = "/distributionCustomer/list", method = RequestMethod.POST)
    public ResponseEntity<BaseResponse> distributionCustomer(@RequestBody DistributionCustomerPageRequest request) {
        return ResponseEntity.ok(distributionCustomerQueryProvider.page(request));
    }
}
