...
import com.wanmi.sbc.customer.api.request.store.StoreDocumentByIdRequest;
import com.wanmi.sbc.customer.api.request.store.StoreHomeInfoRequest;
import com.wanmi.sbc.customer.api.request.store.StoreQueryBySkuIdRequest;
...
import com.wanmi.sbc.customer.api.response.store.StoreDocumentResponse;
import com.wanmi.sbc.customer.api.response.store.StoreHomeInfoResponse;
import com.wanmi.sbc.customer.api.response.store.ValidStoreByIdResponse;
 ...
 */
@Tag(name = "StoreBaseController", description = "店铺信息查询 API")
@RestController
@Validated
...
public class StoreBaseController {
    ...
    public BaseResponse<StoreBaseResponse> queryStore(@Valid @RequestBody StoreBaseInfoByIdRequest request) {
        StoreBaseResponse response = storeQueryProvider.getStoreBaseInfoById(request).getContext();
    ...
    public BaseResponse<StoreBaseResponse> queryStoreBySkuId(@Valid @RequestBody StoreQueryBySkuIdRequest request) {
        ...
        if (Objects.isNull(storeIdResponse) || Objects.isNull(storeIdResponse.getStoreId())) {
     ...
     * @return
     */
    @Operation(summary = "未登录状态下查询店铺基本信息")
    @RequestMapping(value = "/unLogin/storeInfo", method = RequestMethod.POST)
    public BaseResponse<BossStoreBaseInfoResponse> queryStoreUnlogin(@Valid @RequestBody BossStoreBaseInfoByIdRequest request) {
        BossStoreBaseInfoResponse response =
                storeQueryProvider.getBossStoreBaseInfoById(request).getContext();
        response.setIsFollowed(Boolean.FALSE);
        //店铺评分信息
        StoreEvaluateSumByIdResponse storeEvaluateSumByIdResp = storeEvaluateSumQueryProvider.getByStoreId(
                StoreEvaluateSumQueryRequest.builder().storeId(request.getStoreId())
                        .scoreCycle(ScoreCycle.ONE_HUNDRED_AND_EIGHTY.toValue()).build()).getContext();
     ...
     * @return
     */
    @Operation(summary = "根据skuId未登录状态下查询店铺基本信息")
    @RequestMapping(value = "/unLogin/storeInfoBySkuId", method = RequestMethod.POST)
    public BaseResponse<BossStoreBaseInfoResponse> queryStoreUnlogin(@Valid @RequestBody StoreQueryBySkuIdRequest request) {
        GoodsInfoStoreIdBySkuIdResponse storeIdResponse= goodsInfoQueryProvider.getStoreIdByGoodsId(GoodsInfoStoreIdBySkuIdRequest
                .builder()
                .skuId(request.getSkuId()).build()).getContext();

        if(Objects.isNull(storeIdResponse.getStoreId())) {
            throw new SbcRuntimeException(CommonErrorCodeEnum.K000003);
        }
     ...
     * @return
     */
    @Operation(summary = "查询店铺档案信息(包括签约分类,品牌图片信息)")
    @RequestMapping(value = "/storeDocument", method = RequestMethod.POST)
    public BaseResponse<StoreDocumentResponse> queryStoreDocument(@Valid @RequestBody StoreDocumentByIdRequest request) {
        //1.查询店铺主表信息
        StoreDocumentResponse response = storeQueryProvider.getStoreDocumentById(request).getContext();
...
//        response.setGoodsCount(goodsCountByStoreIdResponse.getGoodsCount());
     ...
     * @return
     */
    @Operation(summary = "查询操作人在店铺的会员等级与折扣信息")
    @RequestMapping(value = "/storeVip", method = RequestMethod.POST)
    public BaseResponse<StoreCustSystemResponse> queryStoreVip(@RequestBody StoreBaseInfoByIdRequest request) {
        ...
        if (store.getCompanyInfo() != null && store.getCompanyInfo().getCompanyInfoId() != null) {
            ...
            relaQueryRequest.setQueryPlatform(Boolean.FALSE);
    ...
    public BaseResponse<StoreCustSystemResponse> queryStoreVipFront(@RequestBody StoreBaseInfoByIdRequest request) {
        if (request.getStoreId() == null) {
            throw new SbcRuntimeException(CommonErrorCodeEnum.K000009);
        }
        //1.查询店铺信息
     ...
     * @return
     */
    @Operation(summary = "查询店铺主页信息(店铺主页用)")
...
//        StoreHomeResponse response = storeService.queryStoreHomeInfo(storeId);
    ...
    public BaseResponse<GetRegisterOrStoreCouponResponse> entryCoupons(@PathVariable String customerId, @PathVariable Long storeId){
        ...
        StoreByIdRequest build = StoreByIdRequest.builder().storeId(storeId).build();
        StoreVO storeVO = storeQueryProvider.getById(build).getContext().getStoreVO();
        //封装订单请求
        TradeListAllRequest tradeListAllRequest = TradeListAllRequest.builder()
                .tradeQueryDTO(TradeQueryDTO.builder()
                        ...
                        .storeType(storeVO.getStoreType())
