...
/** Jwt 配置 Created by aqlu on 15/11/20. */
...
public class JwtProperties {
    ...
    /** 排除的restful url Map；被排除的url将不参与jwt验证； 因为存在只开放GET的查询接口,不开放POST,PUT等操作接口的场景 */
    ...
    /** 注销排除redis校验 */
    private Boolean logoutExcludedRedis = Boolean.FALSE;
