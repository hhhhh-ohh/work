 ...
 */
public class FilterRulesSettingWhereCriteriaBuilder {
    public static Specification<FilterRulesSetting> build(FilterRulesSettingQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            // 多少天内不重复
            if (queryRequest.getDayNum() != null) {
                predicates.add(cbuild.equal(root.get("dayNum"), queryRequest.getDayNum()));
            }
