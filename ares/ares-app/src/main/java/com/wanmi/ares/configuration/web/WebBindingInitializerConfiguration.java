package com.wanmi.ares.configuration.web;

import com.wanmi.ares.configuration.web.support.GlobalValidator;
import com.wanmi.ares.util.SpringContextHolder;
...
public class WebBindingInitializerConfiguration {
    ...
    static class CustomWebBindingInitializer extends ConfigurableWebBindingInitializer {
        ...
        public void initBinder(WebDataBinder binder) {
            GlobalValidator globalValidator = SpringContextHolder.getBean(GlobalValidator.class);
