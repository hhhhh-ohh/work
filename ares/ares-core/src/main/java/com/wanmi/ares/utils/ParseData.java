...
public class ParseData {
    ...
    public static TradeView parseData(TradeBase tradeBase) {
        ...
        tradeView.setOrderConversionRate(tradeBase.getOrderConversion() != null  && tradeBase.getOrderNum() > 0  ? tradeBase.getOrderConversion().doubleValue() : 0);
        tradeView.setPayOrderConversionRate(tradeBase.getPayConversion() != null ? tradeBase.getPayConversion().doubleValue() : 0);
        tradeView.setWholeStoreConversionRate(tradeBase.getAllConversion() != null && tradeBase.getOrderNum() > 0  ? tradeBase.getAllConversion().doubleValue() : 0);
    ...
    public static TradeReport parseDataReport(TradeBase tradeBase) {
        ...
        tradeReport.setOrderConversionRate(tradeBase.getOrderConversion() != null  && tradeBase.getOrderNum() > 0 ? tradeBase.getOrderConversion() : BigDecimal.ZERO);
        tradeReport.setPayOrderConversionRate(tradeBase.getPayConversion() != null ? tradeBase.getPayConversion() : BigDecimal.ZERO);
        tradeReport.setWholeStoreConversionRate(tradeBase.getAllConversion() != null && tradeBase.getOrderNum() > 0  ? tradeBase.getAllConversion() : BigDecimal.ZERO);
    ...
    public static TradeReponse parseDataResponse(TradeBase tradeBase) {
        ...
        tradeReponse.setOrderConversionRate(tradeBase.getOrderConversion() != null   && tradeBase.getOrderNum() > 0 ? tradeBase.getOrderConversion() : BigDecimal.ZERO);
        tradeReponse.setPayOrderConversionRate(tradeBase.getPayConversion() != null ? tradeBase.getPayConversion() : BigDecimal.ZERO);
        tradeReponse.setWholeStoreConversionRate(tradeBase.getAllConversion() != null && tradeBase.getOrderNum() > 0  ? tradeBase.getAllConversion() : BigDecimal.ZERO);
