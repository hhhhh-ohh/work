 ...
 */
@Data
public class EmployeeClientQueryRequest extends BaseRequest {
   ...
   * 排序规则
   *
   * @see com.wanmi.ares.enums.EmployeeClientSort
   */
  private com.wanmi.ares.enums.EmployeeClientSort sort; // required
  /**
   * 当前页码
   */
