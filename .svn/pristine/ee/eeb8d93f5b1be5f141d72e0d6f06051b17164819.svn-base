...
public interface AuditProvider {
     ...
     * @return
     */
    @PostMapping("/setting/${application.setting.version}/audit/goods-column-show-update")
    BaseResponse goodsColumnShowForMobileUpdate(@RequestBody @Valid ConfigRequest request);
     ...
     * @return BaseResponse
     */
    @PostMapping("/setting/${application.setting.version}/audit/secondary-audit-update")
    BaseResponse secondaryAuditUpdate(@RequestBody ConfigStatusModifyByTypeAndKeyRequest request);
