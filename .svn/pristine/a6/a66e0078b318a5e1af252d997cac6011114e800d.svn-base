 ...
 */
@Tag(name = "StoreCateController", description = "店铺分类管理服务API")
@RestController
@Validated
...
public class StoreCateController {
     ...
     * 根据父分类ID查询商品分类
     */
    @Operation(summary = "根据父分类ID查询商品分类")
    @RequestMapping(value = "/list/by/parent/id",method = RequestMethod.POST)
    public BaseResponse<List<StoreCateResponseVO>> listByCateParentId(@RequestBody @Valid StoreCateListByParentIdRequest request) {
        request.setStoreId(commonUtil.getStoreId());
        BaseResponse<StoreCateListByStoreIdResponse> baseResponse =
                storeCateQueryProvider.listByCateParentId(request);
        StoreCateListByStoreIdResponse response = baseResponse.getContext();
        if (Objects.isNull(response)) {
            return BaseResponse.success(Collections.emptyList());
        }
    ...
    @Parameter(name = "storeCateId", description = "店铺分类Id", required = true)
     ...
     */
    @Operation(summary = "编辑店铺商品分类")
    @RequestMapping(method = RequestMethod.PUT)
    public BaseResponse<StoreCateByStoreCateIdResponse> edit(@RequestBody StoreCateModifyRequest saveRequest) {
        Long storeId = commonUtil.getStoreId();
        saveRequest.setStoreId(storeId);
        ...
        request.setStoreCateId(saveRequest.getStoreCateId());
        return storeCateQueryProvider.getByStoreCateId(request);
    }
     ...
     * @param queryRequest 查询条件(分类标识)
     */
    @Operation(summary = "检测店铺分类是否关联了商品")
     ...
     * @param saveRequest
     */
    @Operation(summary = "商家APP里店铺分类排序")
