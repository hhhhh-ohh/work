...
public interface StandardGoodsQueryProvider {
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/standard/list-standard-goods")
    BaseResponse<List<StandardGoodsVO>> listStandardGoods(@RequestBody StandardGoodsPageRequest request);
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/standard/list-standard-sku")
    BaseResponse<List<StandardSkuVO>> listStandardSku(StandardSkuListQueryRequest request);
     ...
     * @return {@link StandardGoodsByIdResponse}
     */
    @PostMapping("/goods/${application.goods.version}/standard/get-byProvider-id")
    BaseResponse<StandardGoodsByIdResponse> getByProviderId(@RequestBody @Valid StandardGoodsByIdRequest request);
