...
public interface EmployeeClientReportMapper {
    ...
    List<EmployeeClientReport> export(@Param("query") ExportQuery query, @Param("storeSelectType") int storeSelectType);

    long countOfExport(@Param("query") ExportQuery query, @Param("storeSelectType") int storeSelectType);
