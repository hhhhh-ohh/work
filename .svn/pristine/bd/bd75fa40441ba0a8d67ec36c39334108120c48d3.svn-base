...
public class EsCustomerDetailDTO implements Serializable {
     ...
     * 客户类型（0:平台客户,1:商家客户）
     */
    @Schema(description = "客户类型（0:平台客户,1:商家客户）")
    ...
    private EsEnterpriseInfoDTO enterpriseInfoVO;
    ...
    public EsEnterpriseInfoDTO getEnterpriseInfo() {
        return Objects.nonNull(enterpriseInfo) ? enterpriseInfo : enterpriseInfoVO;
    }
}
