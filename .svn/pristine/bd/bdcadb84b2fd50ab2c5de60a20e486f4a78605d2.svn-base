...
import com.wanmi.sbc.marketing.api.request.bookingsalegoods.BookingSaleGoodsByIdRequest;
import com.wanmi.sbc.marketing.api.request.bookingsalegoods.BookingSaleGoodsListRequest;
import com.wanmi.sbc.marketing.api.request.bookingsalegoods.BookingSaleGoodsPageRequest;
 ...
 */
@FeignClient(value = "${application.marketing.name}", contextId = "BookingSaleGoodsQueryProvider")
public interface BookingSaleGoodsQueryProvider {
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/page")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/list")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/get-by-id")
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/page-boss")
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/pagebookinggoodsinfo")
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/validate")
    BaseResponse validate(@RequestBody @Valid BookingSaleGoodsValidateRequest request);
}
