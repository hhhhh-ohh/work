...
public interface CustomerLevelRightsQueryProvider {
     ...
     * @author minchen
     */
    @PostMapping("/customer/${application.customer.version}/customerlevelrights/issue-level-rights-for-paying-member")
    BaseResponse<CustomerLevelRightsListResponse> issueLevelRightsForPayingMember(@RequestBody @Valid CustomerLevelRightsQueryRequest customerLevelRightsListReq);
