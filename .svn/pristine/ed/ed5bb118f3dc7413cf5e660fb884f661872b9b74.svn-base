...
public class CouponInfoAddRequest extends BaseRequest {
    ...
    private static final long serialVersionUID = 7182028259893321878L;
    /**
     * 优惠券名称
     */
    ...
    /**
     * 营销类型(0,1,2,3,4) 0全部商品，1品牌，2平台(boss)类目,3店铺分类，4自定义货品（店铺可用）5：门店分类
     */
