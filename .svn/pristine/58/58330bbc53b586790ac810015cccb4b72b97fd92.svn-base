...
import com.wanmi.sbc.vas.bean.vo.sellplatform.SellPlatformGetGoodsAuditVO;
import com.wanmi.sbc.vas.bean.vo.sellplatform.SellPlatformGetGoodsDescVO;
...
@NoArgsConstructor
@Schema
public class SellPlatformGetGoodsResponse implements Serializable {
    ...
    private SellPlatformGetGoodsDescVO desc_info;

    @Schema(description = "商品审核信息")
    private SellPlatformGetGoodsAuditVO audit_info;
