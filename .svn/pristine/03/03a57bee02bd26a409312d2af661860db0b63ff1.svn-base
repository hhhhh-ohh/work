...
public interface SmsSignRepository extends JpaRepository<SmsSign, Long>,
     ...
     */
    @Modifying
    @Query("update SmsSign set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where id = ?1")
     ...
     */
    @Modifying
    @Query("update SmsSign set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where id in ?1")
