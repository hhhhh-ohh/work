...
public interface FollowProvider {
    ...
    /**
     * 更新周期购标识
     * @param request {@link FollowCycleUpdateRequest}
     * @return   {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/follow/cycle-update")
    BaseResponse cycleUpdate(@RequestBody @Valid FollowCycleUpdateRequest request);
