 ...
 **/
@Data
public class FlowDataListRequest extends BaseRequest {

    private static final long serialVersionUID = 226788502093145270L;
    /**
     * 店铺id
     */
    ...
    public String getSortName() {
        switch (this.sortName){
            ...
            case "orderConversionRate":this.sortName = "order_conversion"; break;
            ...
            case "customerUnitPrice":this.sortName = "user_per_price"; break;
            case "everyUnitPrice": this.sortName = "order_per_price"; break;
