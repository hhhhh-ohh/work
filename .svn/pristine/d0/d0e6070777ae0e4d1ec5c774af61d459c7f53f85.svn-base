...
public class MarkeingGoodsLevelService {
        ...
        if (level >= NumberUtils.INTEGER_ZERO) {
            ...
            switch (filterType) {
                ...
                case FLASH_PROMOTION:
                    goodsInfoIds = filterFlashPromotion(goodsInfoIds);
    ...
    public List<String> filterAppointmentAndBooking(List<String> goodsInfoIds) {
        ...
        List<AppointmentSaleDO> appointmentSaleVOList =
                appointmentSaleService.inProgressAppointmentSaleInfoByGoodsInfoIdList(goodsInfoIds);
        ...
        List<BookingSale> bookingSaleVOList =
                bookingSaleService.inProgressBookingSaleInfoByGoodsInfoIdList(goodsInfoIds);
    ...
    public List<String> filterFlashSale(List<String> goodsInfoIds) {
        ...
        List<FlashSaleGoodsVO> flashSaleGoodsVOList = flashSaleGoodsQueryProvider
                .list(FlashSaleGoodsListRequest.builder()
     ...
     * @return
     */
    public List<String> filterFlashPromotion(List<String> goodsInfoIds) {
        if(CollectionUtils.isEmpty(goodsInfoIds)) {
            return new ArrayList<>();
        }
        // 查询进行中的秒杀商品
    ...
    public List<String> filterPointsPrice(List<String> goodsInfoIds, Map<String, GoodsInfoVO> skuMap) {
        List<String> newIds = goodsInfoIds.stream().filter(id -> {
            ...
            if (Objects.isNull(goodsInfoIds) ||
                    goodsInfoVO.getBuyPoint() != null &&
                    !goodsInfoVO.getBuyPoint().equals(NumberUtils.LONG_ZERO)) {
                return false;
            }
            return true;
