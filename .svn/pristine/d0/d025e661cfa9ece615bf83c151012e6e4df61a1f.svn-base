...
public class ExportDataServiceProviderController implements ExportDataServiceProvider {
    ...
    @Override
    public ExportDataView sendExportBusinessDataRequest(@RequestBody @Valid ExportDataRequest request) {
        return exportDataService.sendExportBusinessDataRequest(request);
    }
    ...
    @Override
    public int updateExportData(@Valid ExportDataRequest request) {
        return exportDataService.update(request);
    }
}
