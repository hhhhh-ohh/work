...
@Service
@Slf4j
public class ProviderGoodsExportService implements ExportBaseService {
    ...
    public BaseResponse exportReport(ExportData data) throws Exception {
        ...
        String fileName = String.format("批量导出供货商商品库商品_%s.xls"
        ...
        Column[] colunms = this.getColunms(data.getPlatform() == Platform.SUPPLIER,
                isBoss);
        SXSSFSheet sheet = excelHelper.addSXSSFSheetHead("供货商商品库商品导出", colunms);
        //如果没有数据，直接生成空Excel
