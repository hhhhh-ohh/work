...
@NoArgsConstructor
@AllArgsConstructor
public class MarketingSuitsByMarketingIdResponse extends BasicResponse {
     ...
     * 营销视图对象列表
     */
    @Schema(description = "营销视图对象列表")
    private MarketingVO marketingVO;

    /**
     * 组合商品主表信息
     */
    @Schema(description = "组合商品主表信息")
     ...
     * 组合活动关联商品sku表列表结果
     */
    @Schema(description = "组合活动关联商品sku表列表结果")
