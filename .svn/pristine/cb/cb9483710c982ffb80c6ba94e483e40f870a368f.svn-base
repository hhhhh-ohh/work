 ...
 * 满减
 */
@Tag(name = "MarketingFullReductionController", description = "满减服务API")
@RestController
@Validated
...
public class MarketingFullReductionController {
    ...
    public BaseResponse add(@Valid @RequestBody MarketingFullReductionAddRequest request) {
        ...
        //全局互斥
        marketingBaseService.mutexValidate(MarketingType.REDUCTION, request.getBeginTime(), request.getEndTime(),
