...
public class CouponCateController implements CouponCateProvider {
     ...
     */
    @Override
    public BaseResponse<CouponIdsResponse> isOnlyPlatform(@RequestBody @Valid CouponCateIsOnlyPlatformRequest request) {

        return BaseResponse.success(CouponIdsResponse.builder().couponIds(couponCateService.isOnlyPlatform(request)).build());
    }
}
