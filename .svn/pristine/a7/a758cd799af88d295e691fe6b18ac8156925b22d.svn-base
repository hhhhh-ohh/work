...
public interface MessageSendProvider {
	 ...
	 * @description
	 * @author  lvzhenwei
	 * @date 2021/8/19 3:26 下午
	 * @param request
	 * @return com.wanmi.sbc.common.base.BaseResponse
	 **/
	@PostMapping("/sms/${application.sms.version}/messagesend/modify-send-status")
	BaseResponse modifySendStatus(@RequestBody @Valid ModifyAppMessageStatusRequest request);
