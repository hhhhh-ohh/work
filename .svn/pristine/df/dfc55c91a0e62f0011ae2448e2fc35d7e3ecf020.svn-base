...
public interface SettlementQueryProvider {
    ...
    @PostMapping("/account/${application.account.version}/finance/record/settlement/lakala/page")
    ...
    @PostMapping("/account/${application.account.version}/finance/record/settlement/get-lakal-view")
    BaseResponse<LakalaSettlementGetViewResponse> getLakalaView(@RequestBody @Valid LakalaSettlementGetViewRequest request);
    ...
    @PostMapping("/account/${application.account.version}/finance/record/settlement/get-lakala-by-id")
    BaseResponse<LakalaSettlementGetByIdResponse> getLakalaById(@RequestBody @Valid SettlementGetByIdRequest request);
    ...
    @PostMapping("/account/${application.account.version}/finance/record/lakala/settlement/last")
    BaseResponse<LakalaSettlementGetByIdResponse> getLastLakalaSettlementByStoreId(@RequestBody @Valid SettlementLastByStoreIdRequest request);
    ...
    @PostMapping("/account/${application.account.version}/finance/record/lakala/settlement/init-es-page")
    BaseResponse<SettlementListResponse> initEsLakalaPage(@RequestBody @Valid SettlementPageRequest request);

    @PostMapping("/account/${application.account.version}/finance/record/lakala/settlement/get-settlementuuid")
    BaseResponse<GetBySettlementUuidResponse> getBySettlementUuid(@RequestBody @Valid GetBySettlementUuidRequest request);
}
