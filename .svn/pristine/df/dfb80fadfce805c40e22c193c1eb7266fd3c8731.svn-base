...
public class TradeDeliverRequestDTO extends BaseQueryRequest {
    ...
    @Valid
    private List<ShippingItemDTO> preferentialItemList = new ArrayList<>();
    ...
    public TradeDeliverVO toTradeDevlier(ExpressCompanyVO expressCompany) {
        ...
        tradeDeliver.setPreferentialItemList(KsBeanUtil.convertList(preferentialItemList, ShippingItemVO.class));
