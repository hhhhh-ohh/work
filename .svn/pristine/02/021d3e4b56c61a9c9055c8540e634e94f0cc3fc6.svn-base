...
public interface HoverNavMobileProvider {
	 ...
	 *
	 * @author 马连峰
	 * @param bottomNavModifyRequest 移动端底部导航栏修改参数结构 {@link BottomNavModifyRequest}
	 * @return 修改结果 {@link BaseResponse}
	 */
	@PostMapping("/setting/${application.setting.version}/hover-nav-mobile/modify-bottom-nav")
    BaseResponse modifyBottomNav(@RequestBody @Valid BottomNavModifyRequest bottomNavModifyRequest);
}
