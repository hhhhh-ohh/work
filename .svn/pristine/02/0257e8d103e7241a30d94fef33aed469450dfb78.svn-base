...
public interface DistributionInviteNewProvider {
    ...
    BaseResponse<DistributionInviteNewRecordVO> updateBySupplyAgain(@RequestBody @Valid DistributionInviteNewSupplyAgainRequest request);
    ...
    BaseResponse<DistributionInviteNewSaveResponse> addRegister(@RequestBody @Valid DistributionInviteNewAddRegisterRequest request);
