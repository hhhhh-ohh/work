...
public interface CustomerLevelQueryProvider {
     ...
     *
     */
    @PostMapping("/customer/${application.customer.version}/level/valid-customer-level-for-marketing")
    BaseResponse validLevelForMarketing(@RequestBody @Valid CustomerLevelForMarketingRequest request);


    /**
     * 根据会员ID和店铺Ids查询各店铺与会员等级的Map结果,并且设置默认平台等级
     *
     * @param request 会员Id和店铺Ids参数 {@link CustomerLevelMapByCustomerIdAndStoreIdsRequest}
     * @return 各店铺与会员等级一一映射的响应结果 {@link CustomerLevelMapGetResponse}
     */
    @PostMapping("/customer/${application.customer.version}/level/map-customer-level-by-customer-id-and-store-ids-by-default")
    BaseResponse<CustomerLevelMapGetResponse> listCustomerLevelMapByCustomerIdAndIdsByDefault(@RequestBody @Valid
     ...
     * @return 各店铺与会员等级一一映射的响应结果 {@link CustomerLevelMapGetResponse}
     */
    @PostMapping("/customer/${application.customer.version}/level/map-customer-level-by-customer-id")
    BaseResponse<CustomerLevelMapGetResponse> listCustomerLevelMapByCustomerId(@RequestBody @Valid CustomerLevelMapByCustomerIdAndStoreIdsRequest request);
