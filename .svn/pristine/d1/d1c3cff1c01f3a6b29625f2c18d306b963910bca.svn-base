...
public final class CouponErrorCode {
     ...
     * 兑换活动不存在
     */
    public final static String POINTS_COUPON_NOT_EXIST = "K-080217";

    /**
     * 兑换活动不在进行中，无法关闭
     */
    public final static String POINTS_COUPON_NOT_STARTED = "K-080218";
     ...
     * 活动已暂停
     */
    public final static String ACTIVITY_PAUSE= "K-080115";

    /**
     * 该活动不支持关闭
     */
    public final static String ACTIVITY_NOT_SUPPORT_CLOSE= "K-080116";

    /**
     * 优惠券活动不存在
     */
    public final static String COUPON_ACTIVITY_NOT_FIND= "K-080117";

    /**
     * 可选活动日期发生了变化，请重新选择
     */
    public final static String ACTIVITY_TIME_CLASH = "K-080118";

    /**
     * 仅限新人可领取哦～
     */
    public final static String NEW_COMER_COUPON_CANT_NOT_FETCH = "K-080119";

    /**
     * 券组数量不足
     */
    public final static String NEW_COMER_COUPON_STOCK_NOT_ENOUGH = "K-080120";
}
