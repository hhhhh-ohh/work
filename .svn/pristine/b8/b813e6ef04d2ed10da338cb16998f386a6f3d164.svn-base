...
public class GrouponGoodsInfoWhereCriteriaBuilder {
    public static Specification<GrouponGoodsInfo> build(GrouponGoodsInfoQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            if (Objects.nonNull(queryRequest.getYesOrNo()) && queryRequest.getYesOrNo() == YesOrNo.YES) {
            ...
            // 小于或等于 搜索条件:更新时间截止
            if (queryRequest.getMinGrouponPrice() != null) {
                predicates.add(cbuild.greaterThanOrEqualTo(root.get("grouponPrice"),
                        queryRequest.getMinGrouponPrice()));

            }
            if (queryRequest.getMaxGrouponPrice() != null) {
                predicates.add(cbuild.lessThanOrEqualTo(root.get("grouponPrice"),
                        queryRequest.getMaxGrouponPrice()));
            }
            ...
            if (Objects.nonNull(queryRequest.getGoodsType())) {
                predicates.add(cbuild.equal(goodsInfosJoin.get("goodsType"), queryRequest.getGoodsType()));
            }
            //过滤商品状态
