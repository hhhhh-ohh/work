...
public class ConvertUtils {
    ...
    public static <S,T> List<T> convertList(List<S> sourceList, Class<T> targetClass) {
        ...
        List<T> targetList = JSONArray.parseArray(sourceListJsonStr, targetClass);
        return targetList;
    }
    ...
    public void testConvertList() {
        ...
        System.out.println(JSONObject.toJSONString(goodsInfoList));
    }
    ...
    public void testConvertPage() {
        ...
        System.out.println(JSONObject.toJSONString(infoPage));
    }
