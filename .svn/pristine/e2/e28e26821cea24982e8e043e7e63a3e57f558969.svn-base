...
public class AppointmentSaleQueryRequest extends BaseQueryRequest {
	 ...
	 * 搜索条件:预约开始时间开始
	 */
	@Schema(description = "搜索条件:预约开始时间开始")
	 ...
	 * 搜索条件:预约开始时间截止
	 */
	@Schema(description = "搜索条件:预约开始时间截止")
	@JsonSerialize(using = CustomLocalDateTimeSerializer.class)
	@JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
	 ...
	 * 搜索条件:预约结束时间开始
	 */
	@Schema(description = "搜索条件:预约结束时间开始")
	@JsonSerialize(using = CustomLocalDateTimeSerializer.class)
	@JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
	 ...
	 * 搜索条件:预约结束时间截止
	 */
	@Schema(description = "搜索条件:预约结束时间截止")
	@JsonSerialize(using = CustomLocalDateTimeSerializer.class)
	@JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
	 ...
	 * 搜索条件:抢购开始时间开始
	 */
	@Schema(description = "搜索条件:抢购开始时间开始")
	@JsonSerialize(using = CustomLocalDateTimeSerializer.class)
	@JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
	 ...
	 * 搜索条件:抢购开始时间截止
	 */
	@Schema(description = "搜索条件:抢购开始时间截止")
	@JsonSerialize(using = CustomLocalDateTimeSerializer.class)
	@JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
	 ...
	 * 搜索条件:抢购结束时间开始
	 */
	@Schema(description = "搜索条件:抢购结束时间开始")
	@JsonSerialize(using = CustomLocalDateTimeSerializer.class)
	@JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
	 ...
	 * 搜索条件:抢购结束时间截止
	 */
	@Schema(description = "搜索条件:抢购结束时间截止")
	@JsonSerialize(using = CustomLocalDateTimeSerializer.class)
	@JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
