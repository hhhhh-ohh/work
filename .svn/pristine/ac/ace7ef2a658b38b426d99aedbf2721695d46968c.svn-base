...
public interface FlashSaleSettingQueryProvider {
	 ...
	 * @return
	 */
	@PostMapping("/setting/${application.setting.version}/flashsalesetting/get")
	BaseResponse<FlashSaleSettingResponse> get();
	 ...
	 * @return
	 */
	@PostMapping("/setting/${application.setting.version}/flashsalesetting/getPromotion")
	BaseResponse<FlashSaleSettingResponse> getPromotion();
