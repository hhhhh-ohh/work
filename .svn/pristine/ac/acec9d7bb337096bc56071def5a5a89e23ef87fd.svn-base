...
public class ContractCateQueryController implements ContractCateQueryProvider {
    ...
    public BaseResponse<ContractCateListCateByStoreIdResponse> listCateByStoreId(@RequestBody @Valid ContractCateListCateByStoreIdRequest request) {
        ...
        List<GoodsCate> goodsCateList = contractCateService.listCate(request.getStoreId(),request.getGoodsType());
    ...
    @Override
    public BaseResponse<List<GoodsCateVO>> mapedWechat(@Valid ContractCateListCateByStoreIdRequest request) {
        return BaseResponse.success(contractCateService.mapedWechat(request.getStoreId()));
    }
    ...
    public BaseResponse cateDelVerify(@RequestBody @Valid ContractCateDelVerifyRequest request) {
        ...
        cateIds.add(request.getCateId());
        contractCateService.cateDelVerify(cateIds, request.getStoreId());
