...
public interface CouponMarketingScopeQueryProvider {
    ...
    /**
     * 获取未开始/进行中数据库CouponCache
     *
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/marketing/scope/cache-page")
    BaseResponse<CouponCacheListResponse> cachePage(@RequestBody @Valid
                                                            CouponCacheListRequest
                                                                              request);
}