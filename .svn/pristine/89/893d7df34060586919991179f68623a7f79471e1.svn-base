...
public interface InvoiceProjectQueryProvider {
     ...
     * @return
     */
    @PostMapping("/account/${application.account.version}/invoice/project/get-by-id-del")
    BaseResponse<InvoiceProjectByIdResponse> getAllById(@RequestBody @Valid InvoiceProjectByIdRequest invoiceProjectByIdRequest);
