...
public interface ExpressCompanyQueryProvider {
	 ...
	 *
	 * @author wur
	 * @param expressCompanyByCodeRequest 单个查询物流公司请求参数 {@link ExpressCompanyByCodeRequest}
	 * @return 物流公司详情 {@link ExpressCompanyByIdResponse}
	 */
	@PostMapping("/setting/${application.setting.version}/expresscompany/get-by-code")
	BaseResponse<ExpressCompanyByIdResponse> getByCode(@RequestBody @Valid ExpressCompanyByCodeRequest
															 expressCompanyByCodeRequest);
