...
public interface CustomerSiteQueryProvider {
    ...
    @PostMapping("/customer/${application.customer.version}/updateLoginTime")
    BaseResponse updateLoginTime(@RequestBody @Valid CustomerUpdateLoginTimeRequest updateLoginTimeRequest);
     ...
     * 根据会员账号查询会员信息
     *
     * @param request {@link CustomerByAccountRequest}
     * @return 会员信息 {@link CustomerByAccountResponse}
     */
    @PostMapping("/customer/${application.customer.version}/get-customer-by-customer-account-list")
    BaseResponse<CustomerByCustomerAccountResponse> getCustomerByCustomerAccountList(@RequestBody @Valid CustomerByAccountListRequest
                                                                                 request);
