...
public interface GoodsInfoConvertMapper {
    @Mappings({})
    ...
    @Mappings({})
    DistributorGoodsInfoListVO goodsInfoNestVOToDistributorGoodsInfoListVO(GoodsInfoNestVO bean);

    @Mappings({})
    EsGoodsInfoVO esGoodsVOToEsGoodsInfoVO(EsGoodsVO bean);

    @Mappings({})
    GoodsInfoDetailSimpleResponse detailResponseToDetailResponse(GoodsInfoSimpleDetailByGoodsInfoResponse bean);

    @Mappings({})
    GoodsInfoDetailVO goodsInfoSimpleVOToGoodsInfoDetailVO(GoodsInfoSimpleVO bean);

    @Mappings({})
    List<GoodsInfoDetailSimpleMarketingLabelVO> goodsInfoSimpleVOsToGoodsInfoDetailSimpleMarketingLabelVOs(List<GoodsInfoSimpleVO> bean);

    @Mappings({})
    List<MarketingPluginSimpleLabelVO> pluginLabelsToPluginSimpleLabels(List<MarketingPluginLabelVO> bean);

    @Mappings({})
    MarketingPluginSimpleLabelVO pluginLabelToPluginSimpleLabel(MarketingPluginLabelVO bean);
