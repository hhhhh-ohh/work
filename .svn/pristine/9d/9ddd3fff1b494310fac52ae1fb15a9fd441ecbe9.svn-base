...
public interface GoodsEvaluateRepository extends JpaRepository<GoodsEvaluate, String>,
    ...
    @Modifying
    @Query("update GoodsEvaluate set goodNum = goodNum - 1 where goodNum > 0 and evaluateId = :evaluateId")
    ...
    List<Object> countByGoodsIdsGroupByAndGoodsId(@Param("goodsIds") List<String> goodsIds);
    ...
    List<Object> countFavorteByGoodsIdsGroupByAndGoodsId(@Param("goodsIds") List<String> goodsIds);
     ...
     */
    @Modifying
    @Query("update GoodsEvaluate set isShow = :isShow  where evaluateId = :evaluateId")
    void updateEvaluateIsShow(@Param("evaluateId") String evaluateId, @Param("isShow") Integer isShow);
     ...
     */
    @Modifying
    @Query("update GoodsEvaluate set isShow = :isShow  where isShow <> :isShow")
    void updateAllEvaluateIsShow(@Param("isShow") Integer isShow);
