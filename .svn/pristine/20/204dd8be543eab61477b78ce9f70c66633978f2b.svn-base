...
import com.wanmi.sbc.empower.bean.constant.LedgerResponseCode;
...
@Slf4j
public class LakalaCasherUtils {

    private LakalaCasherUtils() {
    }
    ...
    public static final String LA_KA_LA_CASHER_PAY_CALLBACK_URL = "/tradeCallback/lakala/casher/pay/callBack";
    ...
    public static <T> BaseResponse<T> post(String url, String message, String authorization, Class<T> clazz) {
        ...
        return BaseResponse.info(LedgerResponseCode.LAKALA_ERROR, jsonObject.getString("retMsg"));
    }
    ...
    public static String getAuthorization(String body) {
        ...
        log.info("lakala casher getToken message :  " + message);
        ...
        log.info("lakala casher authorization message :" + authorization);
