...
public interface GoodsCateQueryProvider {
     ...
     * @return 商品分类列表信息 {@link GoodsCateListByConditionResponse}
     */
    @PostMapping("/goods/${application.goods.version}/cate/list-by-parentid")
    BaseResponse<GoodsCateListByConditionResponse> listByParentId(
            @RequestBody @Valid GoodsCateByParentIdRequest request);
     ...
     * @return 分类列表信息 {@link GoodsCateListResponse}
     */
    @PostMapping("/goods/${application.goods.version}/cate/queryForMapWechat")
    BaseResponse<List<GoodsCateVO>> queryForMapWechat();
     ...
     * @return 分类列表信息 {@link GoodsCateListResponse}
     */
    @PostMapping("/goods/${application.goods.version}/cate/list/all")
    BaseResponse<GoodsCateListResponse> listAll();

    /**
     * 查询所有的分类信息Map
     * @return 分类列表Map {@link GoodsCateMapResponse}
     */
    @PostMapping("/goods/${application.goods.version}/all/cate/map")
    BaseResponse<GoodsCateMapResponse> allCateMap();
     ...
     * @return 商品分类列表信息 {@link GoodsCateByIdsResponse}
     */
    @PostMapping("/goods/${application.goods.version}/cate/find-parent-id-by-ids")
    BaseResponse<GoodsCateByIdsResponse> findParentIdByIds(@RequestBody @Valid GoodsCateByIdsRequest request);
}
