...
public interface CustomerGrowthReportMapper {
    ...
    List<CustomerGrowthReport> findCustomerGrowthReportByDateAndStoreType(@Param("startDate") String startDate, @Param("endDate") String endDate, @Param("storeSelectType") int storeSelectType);


    Integer countCustomerReportByStoreType(@Param("customerGrowthReportRequest") CustomerGrowthReportRequest customerGrowthReportRequest, @Param("storeSelectType") int storeSelectType);

    List<CustomerGrowthReport> findAllCustomerGrowReportByStoreType(@Param("customerGrowthReportRequest") CustomerGrowthReportRequest customerGrowthReportRequest,  @Param("pageRequest") PageRequest pageRequest, @Param("storeSelectType") int storeSelectType);
}
