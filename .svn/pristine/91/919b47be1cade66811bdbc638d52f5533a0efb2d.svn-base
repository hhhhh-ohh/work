...
public class MarketingBuyoutPriceController implements MarketingBuyoutPriceProvider {
    ...
    @Override
    public BaseResponse checkMarketingTimeAndRuleConflict(@Valid MarketingBuyoutPriceAddRequest request) {
        marketingBuyoutPriceService.checkMarketingTimeAndRuleConflict(KsBeanUtil.convert(request,
                MarketingBuyoutPriceSaveRequest.class));
