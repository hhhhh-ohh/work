...
public class EsStoreInformationQueryController implements EsStoreInformationQueryProvider {
    ...
    @Override
    public BaseResponse<EsListStoreByNameForAutoCompleteResponse> queryStoreByNameAndStoreTypeForAutoComplete(
    ...
    @Override
    public BaseResponse<EsListStoreByNameForAutoCompleteResponse> queryStoreByStoreIds(StoreInfoQueryPageRequest storeInfoQueryPageRequest) {
        return BaseResponse.success(esCompanyAccountService.queryStoreByStoreIds(storeInfoQueryPageRequest));
    }
}
