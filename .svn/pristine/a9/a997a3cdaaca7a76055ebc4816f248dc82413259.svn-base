...
public class DistributionSettingQueryController implements DistributionSettingQueryProvider {
	...
	public BaseResponse<DistributionSettingGetResponse> getSetting() {
		return BaseResponse.success(distributionSettingService.querySetting(Boolean.FALSE));
	}
	 ...
	 */
	@Override
	public BaseResponse<DistributionSettingGetResponse> getSettingIsBoss() {
		return BaseResponse.success(distributionSettingService.querySetting(Boolean.TRUE));
	}
	...
	@Override
	public BaseResponse<Boolean> isStoreBag(String goodsInfoId){
		return BaseResponse.success(distributionSettingService.isStoreBag(goodsInfoId));
	}
}
