...
public interface CouponActivityProvider {
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/activity/query-register-coupon")
    BaseResponse<GetRegisterOrStoreCouponResponse>  queryRegisterCoupon(@RequestBody @Valid GetRegisterCouponRequest request);
    ...
    /**
     * 关闭活动
     * @param request 关闭活动请求结构 {@link CouponActivityCloseRequest}
     * @return {@link BaseResponse}
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/activity/close")
    BaseResponse closeActivity(@RequestBody @Valid CouponActivityCloseRequest request);

    @PostMapping("/marketing/${application.marketing.version}/coupon/activity/precision-vouchers")
    BaseResponse precisionVouchers(@RequestBody @Valid CouponActivityGetDetailByIdAndStoreIdRequest request);
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/activity/modify/pause")
    BaseResponse<CouponActivityModifyResponse> modifyPauseCouponActivity(@RequestBody @Valid CouponActivityModifyRequest request);
