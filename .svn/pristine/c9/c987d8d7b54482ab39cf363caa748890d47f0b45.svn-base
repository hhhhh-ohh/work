...
@Data
@Schema
public class LakalaAllPayRequest implements Serializable {
    ...
    private List<OutSplitInfo> outSplitInfo;
    ...
    @Schema
    @Data
    public static class OutSplitInfo{
        @Schema(description = "外部子交易流水号")
        @JSONField(name = "out_sub_trade_no")
