...
public class DistributorGoodsInfoController implements DistributorGoodsInfoProvider {
     ...
     */
    @Override
    public BaseResponse modifyByStoreIdAndStatusForLaKaLA(@RequestBody @Valid DistributorGoodsInfoModifyByStoreIdAndStatusRequest request) {
        distributorGoodsInfoService.modifyByStoreIdAndStatusForLaKaLA(request.getStoreId(), request.getStatus(),request.getCustomerId());
    ...
    public BaseResponse checkCountsByCustomerId(@RequestBody @Valid DistributorGoodsInfoByCustomerIdRequest request) {
        ...
        return new BaseResponse(CustomerErrorCodeEnum.K010160);
    }
     ...
     */
    @Override
    public BaseResponse updateStatusForLaKaLa(@RequestBody DistributorGoodsInfoModifyByStoreIdAndCustomerIdRequest request) {
       distributorGoodsInfoService.updateStatusForLaKaLa(request.getStoreId(),request.getCustomerId());
        return BaseResponse.SUCCESSFUL();
    }
