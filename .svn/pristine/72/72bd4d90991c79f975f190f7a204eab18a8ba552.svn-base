...
public interface PointsCouponSaveProvider {
     ...
     * 关闭积分兑换券API
     *
     * @param request 关闭积分兑换券参数结构 {@link PointsCouponCloseRequest}
     * @return 状态结果 {@link BaseResponse}
     * @author yang
     */
    @PostMapping("/marketing/${application.marketing.version}/pointscoupon/close")
    BaseResponse close(@RequestBody @Valid PointsCouponCloseRequest request);
