...
public interface FullGiftProvider {
     ...
     * @param request
     */
    @PostMapping("/marketing/${application.marketing.version}/full-gift/reduce-stock")
    BaseResponse  reduceStock(@RequestBody @Valid FullGiftReduceStockRequest request);
