...
public interface CouponActivityQueryProvider {
    ...
    /**
     * 查询距离开始指定时间范围内的数据并标记为已扫描
     * @param request 单位分钟
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/activity/get-activity-by-start-time")
    BaseResponse<CouponActivityByStartTimeResponse> getActivityByStartTime(@RequestBody @Valid CouponActivityByStartTimeRequest request);

    /**
     * 根据小程序二维码scene获取活动配置信息
     * @param request 小程序二维码scene
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/activity-config-by-scene")
    BaseResponse<CouponActivityConfigBySceneResponse> getCouponActivityConfigByScene(@RequestBody @Valid CouponActivityConfigBySceneRequest request);

    /**
     * 根据券id和活动id获取小程序二维码scene
     * @param request 券id和活动id
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/scene-by-coupon-info")
    BaseResponse<CouponActivitySceneResponse> getSceneByCouponInfo(@RequestBody @Valid MagicCouponInfoRequest request);
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/activity/get-by-draw-id")
    BaseResponse<CouponActivityGetByIdResponse> getByDrawActivityId(@RequestBody @Valid CouponActivityByDrawIdRequest request);
}
