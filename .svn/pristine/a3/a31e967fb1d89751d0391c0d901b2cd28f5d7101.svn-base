...
@EnableAsync
@MapperScan(basePackages = {"com.wanmi.ares.**.dao", "com.wanmi.ares.export.dao", "com.wanmi.ares.marketing.*" +
        ".dao"})
...
@EnableFeignClients(basePackages = {"com.wanmi.ares.provider", "com.wanmi.sbc.setting.api", "com.wanmi.sbc.mq.api", "com.wanmi.sbc.customer.api"})
