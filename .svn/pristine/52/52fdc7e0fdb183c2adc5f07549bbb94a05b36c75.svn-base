...
@NoArgsConstructor
@AllArgsConstructor
public class RecommendCateQueryRequest extends BaseQueryRequest {

	private static final long serialVersionUID = 2570308598282433135L;

	/**
	 * 批量查询-分类idList
	 */
	@Schema(description = "批量查询-分类idList")
