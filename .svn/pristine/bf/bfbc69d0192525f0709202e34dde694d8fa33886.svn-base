...
public interface GoodsCateThirdCateRelProvider {
	 ...
	 * @author
	 */
	@PostMapping("/goods/${application.goods.version}/goodscatethirdcaterel/addBatchForWechat")
	BaseResponse addBatchForWechat(@RequestBody @Valid GoodsCateThirdCateRelAddRequest goodsCateThirdCateRelAddRequest);
	 ...
	 * @return
	 */
	@PostMapping("/goods/${application.goods.version}/goodscatethirdcaterel/deleteByThirdCateId")
	BaseResponse deleteWechat(@RequestBody @Valid DeleteWechatCateMapRequest request);

	/**
	 * 修改第三方平台类目映射苏噢关联的商品信息
	 *
	 * @author
	 * @param request 平台类目和第三方平台类目映射新增参数结构 {@link GoodsCateThirdCateRelAddRequest}
	 * @return 新增的平台类目和第三方平台类目映射信息 {@link GoodsCateThirdCateRelAddResponse}
	 */
	@PostMapping("/goods/${application.goods.version}/third-sync-cate/add")
	BaseResponse<GoodsCateThirdCateRelAddResponse> modifyThirdCate(@RequestBody @Valid GoodsByThirdCateRequest request);
