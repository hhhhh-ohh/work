...
public class CustomerInvoiceController implements CustomerInvoiceProvider {
    ...
    public BaseResponse deleteOne(@RequestBody @Valid CustomerInvoiceDeleteOneRequest request) {
        customerInvoiceService.deleteCustomerInvoice(request.getCustomerInvoiceId(),request.getCustomerId());
        return BaseResponse.SUCCESSFUL();
    }
