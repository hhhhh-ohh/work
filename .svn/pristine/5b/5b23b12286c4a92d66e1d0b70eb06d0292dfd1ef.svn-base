...
@NoArgsConstructor
@AllArgsConstructor
public class CustomerPlanByActivityIdResponse extends BasicResponse {
    private static final long serialVersionUID = 1L;

    /**
     *  人群运营计划信息
     */
    @Schema(description = "人群运营计划信息")
    private CustomerPlanVO customerPlanVO;

    /**
     *  人群运营计划优惠券列表
     */
    @Schema(description = "人群运营计划优惠券列表")
    private List<CustomerPlanCouponVO> customerPlanCouponList;

    /**
     *  人群运营计划SMS信息
     */
    @Schema(description = "人群运营计划SMS信息")
    private CustomerPlanSmsVO planSms;

    /**
     *  人群运营计划APP通知信息
     */
    @Schema(description = "人群运营计划APP通知信息")
