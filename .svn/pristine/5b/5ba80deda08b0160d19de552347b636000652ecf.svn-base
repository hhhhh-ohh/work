...
public interface CustomerDetailQueryProvider {
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/detail/list-customer-detail-by-agent-unique-code")
    BaseResponse<CustomerDetailListByConditionResponse> listCustomerDetailByAgentUniqueCode(@RequestBody @Valid CustomerDetailListByAgentUniqueCodeRequest request);
}
