...
public class GoodsInfoSiteQueryController implements GoodsInfoSiteQueryProvider {
    ...
    @Override
    public BaseResponse<GoodsInfoSimpleDetailByGoodsInfoResponse> getSimpleByGoodsInfo(@Valid GoodsInfoRequest goodsInfoRequest) {

        return BaseResponse.success(this.goodsInfoSiteService.getSimpleDetail(goodsInfoRequest));
    }
}
