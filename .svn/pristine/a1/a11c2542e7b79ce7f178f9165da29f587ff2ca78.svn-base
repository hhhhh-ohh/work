...
public interface StandardSkuSpecDetailRelRepository extends JpaRepository<StandardSkuSpecDetailRel, Long>, JpaSpecificationExecutor<StandardSkuSpecDetailRel>{
     ...
     * @return
     */
    @Query("from StandardSkuSpecDetailRel w where w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and w.goodsId = ?1")
     ...
     * @return
     */
    @Query("from StandardSkuSpecDetailRel w where w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and w.goodsId in ?1")
     ...
     * @return
     */
    @Query("from StandardSkuSpecDetailRel w where w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and w.goodsInfoId in ?1")
     ...
     */
    @Modifying
    @Query("update StandardSkuSpecDetailRel w set w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES , w.updateTime = now() where w.goodsInfoId in ?1 and w.goodsId = ?2")
     ...
     */
    @Modifying
    @Query("update StandardSkuSpecDetailRel w set w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES , w.updateTime = now() where w.goodsId = ?1")
     ...
     */
    @Modifying
    @Query("update StandardSkuSpecDetailRel w set w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES , w.updateTime = now() where w.goodsId in ?1")
