...
/**
 * <p>推荐商品与付费会员等级关联表动态查询条件构建器</p>
 * @author zhanghao
 * @date 2022-05-13 13:41:51
 */
public class PayingMemberRecommendRelWhereCriteriaBuilder {
    public static Specification<PayingMemberRecommendRel> build(PayingMemberRecommendRelQueryRequest queryRequest) {
