...
-- 主要dataGalaxy项目jpa实体的加载，所以留空表
-- o2o商品SPU扩展表
CREATE TABLE `s2b_statistics`.`replay_o2o_goods_extension` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '门店商品扩展信息主键',
  `store_id` bigint(20) NOT NULL COMMENT '店铺主键',
  `goods_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `market_price` decimal(20,2) DEFAULT NULL COMMENT '门店设定市场价',
  `added_flag` tinyint(4) DEFAULT NULL COMMENT '上下架状态,0:下架1:上架2:部分上架',
  `added_timing_flag` tinyint(4) DEFAULT NULL COMMENT '是否定时上架 0:否1:是',
  `added_timing_time` datetime DEFAULT NULL COMMENT '定时上架时间',
  `added_time` datetime DEFAULT NULL COMMENT '上下架时间',
  `stock` bigint(20) DEFAULT NULL COMMENT '库存（准实时）',
  ...
  `update_time_stamp` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间戳',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='门店商品扩展信息表';

-- o2o商品SKU扩展表
CREATE TABLE `s2b_statistics`.`replay_o2o_goods_sku_extension` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '门店商品扩展信息主键',
  `store_id` bigint(20) NOT NULL COMMENT '店铺主键',
  `goods_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `market_price` decimal(20,2) DEFAULT NULL COMMENT '门店设定市场价',
  `stock` bigint(20) DEFAULT NULL COMMENT '库存（准实时）',
  `vendibility` tinyint(4) NOT NULL COMMENT '1	是否可售，0不可售，1可售',
  `added_flag` tinyint(4) DEFAULT NULL COMMENT '上下架状态,0:下架1:上架2:部分上架',
  `added_timing_flag` tinyint(4) DEFAULT NULL COMMENT '是否定时上架 0:否1:是',
  `added_timing_time` datetime DEFAULT NULL COMMENT '定时上架时间',
  `added_time` datetime DEFAULT NULL COMMENT '上下架时间',
  ...
  `update_time_stamp` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间戳',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='门店商品SKU扩展信息表';

CREATE TABLE `s2b_statistics`.`replay_o2o_store_cate_base` (
  `o2o_store_cate_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '门店商品分类主键',
  `cate_name` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `pin_yin` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_pin_yin` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint(4) NOT NULL COMMENT '删除标识,0:未删除1:已删除',
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  `is_default` tinyint(4) NOT NULL COMMENT '是否默认,0:否1:是',
  PRIMARY KEY (`o2o_store_cate_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='门店商品分类模板';
