...
public enum AccoutAssetsType {
     ...
     * 审核成功通知
     */
    @ApiEnumProperty("10:授信审核成功通知")
    CREDIT_AUDIT_PASS_NOTICE("CREDIT_AUDIT_PASS_NOTICE","授信审核成功通知"),

    /***
     * 审核驳回通知
     */
    @ApiEnumProperty("11:授信申请驳回通知")
    CREDIT_AUDIT_REJECTED_NOTICE("CREDIT_AUDIT_REJECTED_NOTICE","授信申请驳回通知"),

    /***
     * 变更成功通知
     */
    @Schema(description = "12:授信变更成功通知")
    CREDIT_CHANGE_PASS_NOTICE("CREDIT_CHANGE_PASS_NOTICE","授信变更成功通知"),

    /***
     * 变更驳回通知
     */
    @Schema(description = "13:授信变更驳回通知")
    CREDIT_CHANGE_REJECTED_NOTICE("CREDIT_CHANGE_REJECTED_NOTICE","授信变更驳回通知"),

    /***
     * 还款提醒
     */
    @Schema(description = "14:授信还款提醒")
    CREDIT_REPAY_NOTICE("CREDIT_REPAY_NOTICE","授信还款提醒"),

    /***
     * 逾期提醒
     */
    @Schema(description = "15:授信逾期提醒")
    CREDIT_OVERDUE_NOTICE("CREDIT_OVERDUE_NOTICE","授信逾期提醒");
