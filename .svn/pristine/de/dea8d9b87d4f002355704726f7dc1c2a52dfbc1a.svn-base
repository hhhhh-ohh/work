...
import com.wanmi.sbc.setting.api.request.storeexpresscompanyrela.*;
...
public interface StoreExpressCompanyRelaSaveProvider {
	 ...
	 * @return
	 **/
	@PostMapping("/setting/${application.setting.version}/storeexpresscompanyrela/delete-by-express-company-id")
	BaseResponse deleteByExpressCompanyId(@RequestBody @Valid StoreExpressCompanyRelaDelByExpressCompanyIdRequest request);
