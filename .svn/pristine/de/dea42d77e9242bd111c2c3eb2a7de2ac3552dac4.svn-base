...
@Tag(name = "MessageController", description = "站内信任务相关API")
public class MessageController {
    ...
    @Parameter(name = "id", description = "站内信任务id", required = true)
    @Operation(summary = "查看站内信任务详情")
