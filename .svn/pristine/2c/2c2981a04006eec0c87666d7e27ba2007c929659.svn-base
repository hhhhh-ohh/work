...
public interface DistributionSettingQueryProvider {
	 ...
	 * @return 分销设置详情 {@link DistributionSettingGetResponse}
	 */
	@PostMapping("/marketing/${application.marketing.version}/distribution/setting/queryIsBoss")
	BaseResponse<DistributionSettingGetResponse> getSettingIsBoss();
	...
	*/
	 ...
	 * @return
	 */
	@PostMapping("/marketing/${application.marketing.version}/distribution/setting/is-store-bag")
	BaseResponse<Boolean> isStoreBag(@RequestBody String goodsInfoId);
