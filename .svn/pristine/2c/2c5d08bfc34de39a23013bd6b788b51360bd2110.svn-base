...
public interface GoodsQueryProvider {
     ...
     *
     * @param goodsCacheInfoByIdRequest {@link GoodsCacheInfoByIdRequest}
     * @return 商品信息 {@link GoodsViewByIdResponse}
     */
     ...
     * @return 商品信息 {@link GoodsViewByIdResponse}
     */
    @PostMapping("/goods/${application.goods.version}/get-channel-goods-detail")
    BaseResponse<GoodsDetailProperResponse> getChannelGoodsDetail(@RequestBody @Valid GoodsDetailProperBySkuIdRequest request);
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/count-need-syn")
    BaseResponse<GoodsListNeedSynCountResponse> countNeedSyn(@RequestBody @Valid GoodsQueryNeedSynRequest request);

    /**
     * 根据不同条件查询商品部分字段信息
     *
     * @param goodsByConditionRequest {@link GoodColsByConditionRequest}
     * @return  {@link GoodsColsByConditionResponse}
     */
    @PostMapping("/goods/${application.goods.version}/list-cols-by-condition")
    BaseResponse<GoodsColsByConditionResponse> listColsByCondition(@Valid @RequestBody GoodColsByConditionRequest goodsByConditionRequest);
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/check-bind-electronic-coupons")
    BaseResponse<String> checkBindElectronicCoupons(@Valid @RequestBody GoodsCheckBindRequest goodsCheckBindRequest);
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/find-by-goods-type")
    BaseResponse<GoodsInfoListByGoodsTypeResponse> findByGoodsType(@Valid @RequestBody GoodsByTypeRequest goodsByTypeRequest);
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/find-by-electronic-coupons-id")
    BaseResponse<GoodsInfoListByIdResponse> findByElectronicCouponsId(@Valid @RequestBody GoodsCheckBindRequest goodsCheckBindRequest);

    /**
     * 查询已绑定过卡券的id
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/find-electronic_coupon_ids")
    BaseResponse<GoodsElectronicIdResponse> findElectronicCouponIds(@Valid @RequestBody GoodsElectronicIdRequest goodsElectronicIdRequest);


    /**
     * 验证商家是否代销此商品
     * @param goodsSellRequest
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/find-sell_goods")
    BaseResponse<GoodsSellResponse> findSellGoods(@Valid @RequestBody GoodsSellRequest goodsSellRequest);

    /**
     * 查询商品图片信息
     * @param goodsImageRequest
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/find-goods-image")
    BaseResponse<GoodsImageResponse> findGoodsImageByGoodsId(@Valid @RequestBody GoodsImageRequest goodsImageRequest);

    /**
     * 根据商品Id查询商品名称
     */
    @PostMapping("/goods/${application.goods.version}/find-goods-name")
    BaseResponse<List<String>> findGoodsNameByIds (@Valid @RequestBody List<String> joinGoodsIdList);
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/find-goods-main-image")
    BaseResponse<GoodsMainImageResponse> findGoodsMainImageByGoodsId(@Valid @RequestBody List<String> goodsIdList);
