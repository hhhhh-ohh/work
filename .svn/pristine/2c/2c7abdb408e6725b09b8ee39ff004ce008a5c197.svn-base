...
public interface CouponCateRepository extends JpaRepository<CouponCate, String>, JpaSpecificationExecutor<CouponCate> {
     ...
     * @return
     */
    @Query(" from CouponCate c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.couponCateId in (?1) ")
     ...
     * @return
     */
    @Query(" from CouponCate c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO order by c.cateSort asc, c.createTime desc")
     ...
     * @return
     */
    @Query(" from CouponCate c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.couponCateId = ?1 ")
     ...
     * @param couponCateId
     */
    @Query(" update CouponCate c set c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES,  c.delPerson = ?2 , c" +
            ".delTime = ?3 where c.couponCateId = ?1 ")
    @Modifying
     ...
     * @return
     */
    @Query(" from CouponCate c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.onlyPlatformFlag = '0'" +
            " order by c.cateSort asc, c.createTime desc")
    List<CouponCate> listCouponCateForSupplier();

    @Query(" from CouponCate c where c.couponCateId in ?1 and c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO")
