...
@Tag(name =  "S2B的预售商品服务", description =  "BookingGoodsController")
public class BookingGoodsController {
    ...
    public BaseResponse<BookingResponse> page(@RequestBody @Valid BookingGoodsInfoSimplePageRequest request) {
        ...
        ).build()).getContext().getStoreVOList().stream().collect(Collectors.toMap(StoreVO::getStoreId, Function.identity()));
