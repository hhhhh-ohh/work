...
@Slf4j
@Service
public class GoodsInfoStockReplaceService {

    @Autowired private GoodsMqConsumerProvider goodsMqConsumerProvider;

    @Bean
    public Consumer<Message<String>> mqGoodsInfoStockReplaceService() {
        return message->{
            ...
            goodsMqConsumerProvider.replaceGoodsInfoStock(goodsMqConsumerRequest);
        };
    }
}
