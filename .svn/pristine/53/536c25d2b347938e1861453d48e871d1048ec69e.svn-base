...
/**
 * @author lvzhenwei
 * @className OpenGrouponService
 * @description 团长开团延迟MQ生产者消息通道
 * @date 2021/8/17 10:12 上午
 */
@Slf4j
@Service
public class OpenGrouponService {

    @Autowired private OrderMqConsumerProvider orderMqConsumerProvider;

    @Bean
    public Consumer<Message<String>> mqOpenGrouponService() {
        return message->{
            ...
            orderMqConsumerProvider.openGroupon(orderMqConsumerRequest);
        };
    }
}
