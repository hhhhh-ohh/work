...
public interface CouponCodeQueryProvider {
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/code/auto-select-for-confirm")
    BaseResponse<CouponCodeAutoSelectResponse> autoSelectForConfirm(@RequestBody @Valid CouponCodeAutoSelectForConfirmRequest request);
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/code/auto-select-for-cart")
    BaseResponse<CouponDiscountDetailForCartResponse> autoSelectForCart(@RequestBody @Valid CouponCodeAutoSelectForCartRequest request);
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/code/page-coupon-code-by-condition-test")
    BaseResponse<CouponCodePageByConditionResponse> pageCouponCodeByCondition_test(@RequestBody @Valid CouponCodeQueryRequest request);
