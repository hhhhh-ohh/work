...
public class AgentBaseController {
    ...
    private final AgentQueryProvider agentQueryProvider;
    private final AgentAuditLogProvider agentAuditLogProvider;
    private final AgentAuditLogQueryProvider agentAuditLogQueryProvider;
