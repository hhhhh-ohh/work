 ...
 */
@Mapper
public interface GoodsCateMapper extends GoodsMapper{
    ...
    List<Long> queryGoodsCateChild(@Param("catePath") String catePath);

    String queryGoodsCatePath(@Param("cateId") Integer cateId);
     ...
     * @return
     */
    List<GoodsCateReport> queryGoodsCateReportByExport(GoodsQueryCriteria criteria);

    /**
     * 根据cateId查询详细的分类信息
     * @param cateQueryRequest
     * @return
     */
    List<GoodsCate> queryGoodsCateByIds(GoodsCateQueryRequest cateQueryRequest);
}
