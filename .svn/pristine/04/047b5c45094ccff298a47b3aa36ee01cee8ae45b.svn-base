...
/**
 * @description SellPlatformAcceptReturnOrderRequest
 * @author wur
 * @date: 2022/4/20 9:39
 */
@Data
...
@NoArgsConstructor
@Schema
public class SellPlatformAcceptReturnOrderRequest extends SellPlatformBaseRequest {
    ...
    private SellPlatformReturnAddressVO returnAddressVO;
