...
@Builder
@Schema
public class ReturnItemVO extends BasicResponse {
     ...
     * @return
     */
    public DiffResult<ReturnItemVO> diff(ReturnItemVO returnItem) {
    ...
    public void merge(ReturnItemVO newReturnItem) {
        DiffResult<ReturnItemVO> diffResult = this.diff(newReturnItem);
    ...
    private void mergeSimple(String fieldName, Object right) {
        ...
        try {
            ...
            throw new SbcRuntimeException(OrderErrorCodeEnum.K050023, new Object[]{ReturnItemVO.class, fieldName});
        }
    }
    ...
    public List<String> buildDiffStr(ReturnItemVO returnItem) {
        DiffResult<ReturnItemVO> diffResult = this.diff(returnItem);
