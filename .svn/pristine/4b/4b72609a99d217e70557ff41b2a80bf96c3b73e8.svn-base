...
@Data
@Schema
public class EsStoreVo extends BasicResponse {
    ...
    public  EsStoreVo convertFromNativeSQLResult(Object result) {
        ...
        response.setCompanyInfoId(((Long) ((Object[]) result)[0]));
        response.setStoreId(((Long) ((Object[]) result)[1]));
        ...
        //二次签约审核状态
        Byte contractAuditState = StringUtil.cast(results, 14, Byte.class);
        response.setContractAuditState(contractAuditState !=null ? contractAuditState.intValue():null);

        //二次签约审核驳回原因
        response.setContractAuditReason((String)((Object[]) result)[15]);
