...
public interface StandardImportProvider {
     ...
     *
     */
    @PostMapping("/goods/${application.goods.version}/standard/import-goods-info")
    BaseResponse<GoodsInfoConsignIdResponse> importGoodsInfo(@RequestBody @Valid GoodsInfoConsignIdRequest request);
