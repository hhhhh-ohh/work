...
public class OplogParserHandler {
    ...
    private static final String OP_DELETE = "d";
     ...
     public OplogData process(Map<String,Object> dbObject) {
         ...
         //操作的数据集合
         Document basicDBObject = (Document) dbObject.get("o");
         String data = JSON.toJSONString(basicDBObject);
         String _id = null;
         ...
         if (OP_INSERT.equals(op)) {
             ...
             condition = JSON.toJSONString(dbObject.get("o2"));

             _id = ((Document)dbObject.get("o2")).get("_id").toString();
