 ...
 */
@FeignClient(value = "${application.marketing.name}", contextId = "AppointmentSaleGoodsProvider")
public interface AppointmentSaleGoodsProvider {
     ...
     * @author zxd
     */
    @PostMapping("/marketing/${application.marketing.version}/appointmentsalegoods/add")
     ...
     * @author zxd
     */
    @PostMapping("/marketing/${application.marketing.version}/appointmentsalegoods/modify")
     ...
     * @author zxd
     */
    @PostMapping("/marketing/${application.marketing.version}/appointmentsalegoods/delete-by-id")
     ...
     * @author zxd
     */
    @PostMapping("/marketing/${application.marketing.version}/appointmentsalegoods/delete-by-id-list")
     ...
     * @param request
     */
    @PostMapping("/marketing/${application.marketing.version}/appointmentsalegoods/update-appointment-count")
     ...
     * @param request
     */
    @PostMapping("/marketing/${application.marketing.version}/appointmentsalegoods/update-buy-count")
