 ...
 */
public class RecommendSystemConfigWhereCriteriaBuilder {
    public static Specification<RecommendSystemConfig> build(RecommendSystemConfigQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            if (StringUtils.isNotEmpty(queryRequest.getConfigKey())) {
                predicates.add(cbuild.like(root.get("configKey"), StringUtil.SQL_LIKE_CHAR
                        .concat(XssUtils.replaceLikeWildcard(queryRequest.getConfigKey()))
                        .concat(StringUtil.SQL_LIKE_CHAR)));
            }

            // 模糊查询 - 类型
            if (StringUtils.isNotEmpty(queryRequest.getConfigType())) {
                predicates.add(cbuild.like(root.get("configType"), StringUtil.SQL_LIKE_CHAR
                        .concat(XssUtils.replaceLikeWildcard(queryRequest.getConfigType()))
                        .concat(StringUtil.SQL_LIKE_CHAR)));
            }

            // 模糊查询 - 名称
            if (StringUtils.isNotEmpty(queryRequest.getConfigName())) {
                predicates.add(cbuild.like(root.get("configName"), StringUtil.SQL_LIKE_CHAR
                        .concat(XssUtils.replaceLikeWildcard(queryRequest.getConfigName()))
                        .concat(StringUtil.SQL_LIKE_CHAR)));
            }
