...
/**
 * @author
 * @className LklOrderTradeInfoDTO
 * @description
...
@NoArgsConstructor
@Builder
public class LklOrderTradeInfoDTO implements Serializable {

    private static final long serialVersionUID = -8147423136905856744L;
