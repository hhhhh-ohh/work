...
public interface OrderInvoiceRepository extends JpaRepository<OrderInvoice,String>, JpaSpecificationExecutor<OrderInvoice> {
     ...
     */
    @Modifying
    @Query("update OrderInvoice c set c.invoiceState = com.wanmi.sbc.account.bean.enums.InvoiceState.ALREADY ,c.invoiceTime = :invoiceTime ,c.updateTime = now() where c.invoiceState = com.wanmi.sbc.account.bean.enums.InvoiceState.WAIT and c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.orderInvoiceId in :orderInvoiceIds")
     ...
     */
    @Modifying
    @Query("update OrderInvoice c set c.invoiceState = com.wanmi.sbc.account.bean.enums.InvoiceState.WAIT,c.updateTime = :updateTime, c.invoiceTime = null where c.invoiceState = com.wanmi.sbc.account.bean.enums.InvoiceState.ALREADY and c.orderInvoiceId = :orderInvoiceId")
     ...
     */
    @Modifying
    @Query("update OrderInvoice c set c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES,c.updateTime = :updateTime where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.orderInvoiceId = :orderInvoiceId")
     ...
     */
    @Modifying
    @Query("update OrderInvoice c set c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES,c.updateTime = :updateTime where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.orderNo = :orderNo")
