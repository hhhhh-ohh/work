...
public class MQConstant {
    ...
    //
    public static final String Q_ARES_ORDER_CUSTOMER_INFO = "q.ares.order.customer.info";

    // 营销相关的流量的统计
    public static final String Q_FOLLOW_MARKETING_SKU =  "q.flow.marketing.sku.synchronization";
