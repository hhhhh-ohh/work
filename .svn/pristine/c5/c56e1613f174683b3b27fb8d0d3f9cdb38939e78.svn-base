...
public interface DepartmentRepository extends JpaRepository<Department, String>,
     ...
     * @return
     */
    @Query("update Department e set e.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES , e.updateTime = now() where e.departmentId = ?1 ")
    @Modifying
     ...
     * @return
     */
    @Query("update Department e set e.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES , updateTime = now() where e.parentDepartmentIds like ?1% ")
    @Modifying
    ...
    @Modifying
    @Query("UPDATE Department d SET d.employeeNum = (?2) WHERE d.departmentId = (?1)")
    void modifyDepartmentEmployeeNum(String departmentId, Integer num);
}
