...
public class ThirdGoodsCateController implements ThirdGoodsCateProvider {
	...
	@Override
	public BaseResponse updateAllNoDel(UpdateAllRequest request) {
		thirdGoodsCateService.updateAllNoDel(request.getThirdGoodsCateDTOS());
		return BaseResponse.SUCCESSFUL();
	}

	@Override
	public BaseResponse<CheckCateIdResponse> checkCateIdExist(CheckCateIdRequest request) {
		return thirdGoodsCateService.checkCateIdExist(request.getThirdGoodsCateDTOS());
	}

	@Override
	public BaseResponse addAll(UpdateAllRequest request) {
		thirdGoodsCateService.addAll(request.getThirdGoodsCateDTOS());
		return BaseResponse.SUCCESSFUL();
	}
}
