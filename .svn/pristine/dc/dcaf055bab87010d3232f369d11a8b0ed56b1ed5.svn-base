...
public interface CouponCacheProvider {
    ...
    BaseResponse<CouponCacheListNoScopeResponse> listCouponForGoodsList(@RequestBody @Valid CouponCacheListForGoodsListRequest request);
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/coupon/coupon-goods-by-coupon-id")
    BaseResponse<CouponGoodsListResponse> couponGoodsById(@RequestBody @Valid CouponGoodsListRequest request);
