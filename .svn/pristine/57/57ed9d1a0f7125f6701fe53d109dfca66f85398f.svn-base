...
public interface OfflineQueryProvider {
     ...
     * @return 线下账户列表 {@link OfflineAccountListResponse}
     */
    @PostMapping("/account/${application.account.version}/offline/list-by-ids")
    BaseResponse<OfflineAccountListResponse> findOfflineAccountByIds(@RequestBody @Valid OfflineAccountGetByIdsRequest request);
}
