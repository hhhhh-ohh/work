...
public class YunServiceController implements YunServiceProvider {
    ...
    public BaseResponse<YunConfigResponse> getById(@RequestBody @Valid YunConfigByIdRequest yunConfigByIdRequest) {
        ...
        YunConfigResponse yunConfigResponse = JSONObject.parseObject(systemConfig.getContext(), YunConfigResponse.class);
    ...
    public BaseResponse<YunConfigResponse> modify(@RequestBody @Valid YunConfigModifyRequest yunConfigModifyRequest) {
        ...
        if (Objects.nonNull(status) && !status.equals(systemConfig.getStatus()) && status.equals(EnableStatus.ENABLE.toValue())) {
            YunConfigResponse yunConfig = JSONObject.parseObject(systemConfig.getContext(), YunConfigResponse.class);
            if (Objects.isNull(yunConfig.getAccessKeySecret()) ||
                ...
                throw new SbcRuntimeException(SettingErrorCodeEnum.K070042);
            }
    ...
    @Override
    public BaseResponse<YunUploadResourceResponse> saveUploadedFile(YunUploadResourceRequest yunUploadResourceRequest) {
        return BaseResponse.success(yunService.saveUploadFile(yunUploadResourceRequest));
    }
}
