...
public interface ReplayStoreMapper {
    ...
    List<Store> queryByStoreName(@Param("storeName") String storeName,@Param("storeType") Integer storeType);

    List<Store> queryByStoreIds(@Param("storeIds") List<Long> storeIds);
