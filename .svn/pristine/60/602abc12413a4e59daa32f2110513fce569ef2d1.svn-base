 ...
 */
@Service
public class MarketingFullDiscountService implements MarketingFullDiscountServiceInterface{
    ...
    public Marketing addMarketingFullDiscount(MarketingFullDiscountSaveRequest request) throws SbcRuntimeException {
