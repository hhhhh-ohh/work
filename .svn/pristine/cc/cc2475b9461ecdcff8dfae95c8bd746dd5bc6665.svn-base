...
@NoArgsConstructor
@AllArgsConstructor
public class EsActivityCouponDTO {
    ...
    public static List<EsActivityCouponDTO> translateByCache(List<CouponCacheVO> caches) {
        List<EsActivityCouponDTO> esActivityCouponDTOS = Lists.newArrayList();
        if (CollectionUtils.isEmpty(caches)) {
            return esActivityCouponDTOS;
        }
        caches.stream().forEach(cache -> {
            ...
            EsActivityCouponDTO esActivityCouponDTO = EsActivityCouponDTO.builder().id(cache.getActivityConfigId())
                    ...
                    .build();
            esActivityCouponDTOS.add(esActivityCouponDTO);
        });
        return esActivityCouponDTOS;
