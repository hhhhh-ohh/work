...
public interface StoreQueryProvider {
     ...
     * 根据商户名称模糊匹配未删除店铺列表
     *
     * @param listStoreBySupplierNameRequest 包含店铺名称关键字 {@link ListStoreBySupplierNameRequest}
     * @return 返回匹配的店铺列表 {@link ListStoreByNameResponse}
     */
    @PostMapping("/customer/${application.customer.version}/store/list-by-supplier-name")
    BaseResponse<ListStoreByNameResponse> listBySupplierName(@RequestBody @Valid ListStoreBySupplierNameRequest listStoreBySupplierNameRequest);
     ...
     * @return 返回匹配的店铺列表 {@link ListStoreByNameResponse}
     */
    @PostMapping("/customer/${application.customer.version}/store/list-for-distribution-by-supplier-name")
    BaseResponse<StoreListForDistributionResponse> listBySupplierName(@RequestBody @Valid ListStoreByNameRequest
                                                                              listStoreByNameRequest);
     ...
     * @return 店铺信息 {@link NoDeleteStoreByIdResponse}
     */
    @PostMapping("/customer/${application.customer.version}/store/get-cache-no-delete-store-by-id")
    BaseResponse<CacheNoDeleteStoreByIdResponse> getCacheNoDeleteStoreById(@RequestBody @Valid NoDeleteStoreByIdRequest
                                                                         noDeleteStoreByIdRequest);

    /**
     * 店铺下拉框
     *
     * @param listStoreByNameRequest
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/store/store-name-dropdown-box")
    BaseResponse<Map<Long, String>> storeNameDropdownBox(@RequestBody @Valid ListStoreByNameRequest listStoreByNameRequest);
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/store/count")
    BaseResponse<Long> count(@RequestBody @Valid StoreQueryRequest request);
}
