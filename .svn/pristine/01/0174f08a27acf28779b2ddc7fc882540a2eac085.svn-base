 ...
 */
@Tag(name = "DistributionController", description = "分销相关API")
@RestController
@Validated
...
public class DistributionController {
     ...
     * @return
     */
    @Operation(summary = "查询分销设置和邀请人信息")
     ...
     * @return
     */
    @Operation(summary = "根据会员的Id查询该会员的分销员信息")
    ...
    public BaseResponse<DistributionSetting4StoreBagsVerifyResponse> verifyStoreBagsSku(@PathVariable String goodsInfoId) {
        ...
        GoodsInfoNestVO goodsInfo = response.getEsGoods().getContent().stream().map(EsGoodsVO::getGoodsInfos)
                ...
                .findFirst().orElseGet(GoodsInfoNestVO::new);
     ...
     * @return
     */
    @Operation(summary = "查询平台端-社交分销总开关状态")
