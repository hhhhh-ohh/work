...
public interface BaseConfigQueryProvider {
	 ...
	 * @author xuyunpeng
	 * @param
	 * @return 付费会员协议 {@link PayingMemberAgreementResponse}
	 */
	@PostMapping("/setting/${application.setting.version}/baseconfig/paying-member-agreement")
	BaseResponse<PayingMemberAgreementResponse> getPayingMemberAgreement();
}
