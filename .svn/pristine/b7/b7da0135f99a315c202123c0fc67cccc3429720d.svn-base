...
public interface CompanyInfoRepository extends JpaRepository<CompanyInfo, Long>,
     ...
     */
    @Modifying
    @Query("update CompanyInfo set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where companyInfoId = ?1")
     ...
     */
    @Modifying
    @Query("update CompanyInfo set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where companyInfoId in ?1")
