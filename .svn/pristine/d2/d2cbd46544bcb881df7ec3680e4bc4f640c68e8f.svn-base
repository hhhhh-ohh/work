...
@Slf4j
@Service
public class LedgerAccountBaseService {
    ...
    public byte[] reSizeImage(MultipartFile file) throws IOException {
        ...
        try (FileInputStream fis = new FileInputStream(tempFile);
            ...
            if (ImageIO.read(tempFile).getHeight() > Constants.NUM_1000 || ImageIO.read(tempFile).getWidth() > Constants.NUM_1000) {
                ImageUtils.reSize(tempFile, tempFile, Constants.NUM_1000, Constants.NUM_1000, true);
            }
