...
public interface MarketingQueryProvider {
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/get-marketing-simple-by-id-for-customer")
    BaseResponse<MarketingGetByIdForCustomerResponse> getMarketingSimpleByIdForCustomer(@RequestBody @Valid MarketingGetByIdRequest getByIdRequest);
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/get-simple-by-id-for-customer")
    BaseResponse<MarketingSimpleGetByIdForCustomerResponse> getSimpleByIdForCustomer(@RequestBody @Valid MarketingGetByIdRequest getByIdRequest);
