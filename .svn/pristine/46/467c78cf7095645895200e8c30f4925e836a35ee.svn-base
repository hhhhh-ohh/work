...
@NoArgsConstructor
@AllArgsConstructor
public class AppExternalConfigAddResponse implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * 已新增的AppExternalConfig信息
     */
    @Schema(description = "已新增的AppExternalConfig信息")
