...
@Tag(name =  "短信发送任务管理API", description =  "SmsSendController")
@RestController
@Validated
...
public class SmsSendController {
    ...
    @Operation(summary = "根据id查询短信发送任务")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "根据id删除短信发送任务")
    @DeleteMapping("/{id}")
