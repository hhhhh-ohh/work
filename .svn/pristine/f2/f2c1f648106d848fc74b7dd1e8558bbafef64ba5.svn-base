...
@NoArgsConstructor
@AllArgsConstructor
public class AppointmentSaleVO extends BasicResponse {
     ...
     * 是否预约中
     */
    private Boolean appointmentFlag = Boolean.FALSE;

    public void buildAppointmentFlag() {
        LocalDateTime now = LocalDateTime.now();
        if (!now.isBefore(appointmentStartTime) && now.isBefore(appointmentEndTime)) {
            this.appointmentFlag = Boolean.TRUE;
        }
    }
