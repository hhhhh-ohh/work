...
update `sbc-setting`.`menu_info` set menu_name = '数据' where menu_id = 'fc8e07cd3fe311e9828800163e0fc468';
update `sbc-setting`.`menu_info` set menu_name = '数谋' where menu_id = 'ff80808176ae86e40176b1c2a6320001';
update `sbc-setting`.`menu_info` set menu_name = '会员画像' where menu_id = 'ff80808176ae86e40176b1c3876b0002';
update `sbc-setting`.`menu_info` set menu_name = '智能分析' where menu_id = 'ff80808176ae86e40176b1c4035a0004';
update `sbc-setting`.`menu_info` set menu_name = '数据' where menu_id = 'fc8e09333fe311e9828800163e0fc468';
update `sbc-setting`.`menu_info` set sort = 7 where menu_id = 'fc8df0aa3fe311e9828800163e0fc468';
update `sbc-setting`.`menu_info` set sort = 9 where menu_id = 'fc8e07cd3fe311e9828800163e0fc468';
update `sbc-setting`.`menu_info` set sort = 10 where menu_id = 'fc8e20ff3fe311e9828800163e0fc468';
update `sbc-setting`.`menu_info` set sort = 11 where menu_id = 'fc8df1663fe311e9828800163e0fc468';
update `sbc-setting`.`menu_info` set sort = 6 where menu_id = 'fc8e09333fe311e9828800163e0fc468';
update `sbc-setting`.`menu_info` set sort = 5 where menu_id = '808080816cefb4dc016d00201eba0000';
