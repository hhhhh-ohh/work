...
public class GrouponActivityQueryController implements GrouponActivityQueryProvider {
    ...
    public BaseResponse<GrouponActivityByIdResponse> getById(@RequestBody @Valid GrouponActivityByIdRequest request) {
        ...
        List<StoreNameVO> storeNames = storeQueryProvider.listStoreNameByStoreIds(
                new StoreNameListByStoreIdsResquest(Collections.singletonList(Long.valueOf(grouponActivity.getStoreId())))
    ...
    @Override
    public BaseResponse<GrouponActivityVO> getSimpleById(@RequestBody @Valid GrouponActivityByIdRequest request) {

        // 1.查询拼团活动信息
        GrouponActivity grouponActivity = grouponActivityService.getById(request.getGrouponActivityId());
        GrouponActivityVO response =
                grouponActivityService.wrapperVo(grouponActivity);
    ...
    @Override
    public BaseResponse validate(@RequestBody @Valid GrouponGoodsValidateRequest request) {
        grouponActivityService.validate(request);
