...
public class PointsTradeDeliverAction extends PointsTradeAction {
    ...
    private boolean isAllShipped(Trade trade) {
        ...
        allCollect.addAll(trade.getPreferential());
    ...
    private void deliver(Trade trade, Operator operator, TradeDeliver tradeDeliver) {
        ...
        //处理商品
        handleShippingItems(trade, tradeDeliver.getShippingItems(), stringBuilder, operator);
    ...
    private void handleShippingItems(Trade trade, List<ShippingItem> shippingItems, StringBuilder stringBuilder, Operator operator) {
        ...
        shippingItems.forEach(shippingItem -> {
            ...
            if (hasNum.equals(tradeItem.getNum())) {
                ...
                throw new SbcRuntimeException(OrderErrorCodeEnum.K050019, new Object[]{tradeItem.getSkuId(), tradeItem.getNum(), hasNum});
            } else {
    ...
    private void handleGiftShippingItems(Trade trade,
        ...
        ConcurrentHashMap<Long, List<TradeItem>> skuItemMap;
