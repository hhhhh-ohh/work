...
public interface DistributorLevelRepository extends JpaRepository<DistributorLevel, String>,
	...
	@Query(value = "select new com.wanmi.sbc.customer.distribution.model.entity.DistributorLevelBase(c.distributorLevelId,c.distributorLevelName) FROM DistributorLevel c " +
			" where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO order by c.sort ")
	 ...
	 */
	@Modifying
	@Query("update DistributorLevel d set d.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES, d.updateTime = now() where d.distributorLevelId = ?1 ")
	 ...
	 * @return
	 */
	@Query(" from DistributorLevel d where d.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO order by d.sort asc")
	 ...
	 */
	@Modifying
	@Query("update DistributorLevel d set d.distributorLevelName = ?1 where d.sort = 1 and d.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO ")
