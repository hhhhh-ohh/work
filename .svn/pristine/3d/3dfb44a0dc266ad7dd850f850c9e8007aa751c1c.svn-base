...
public interface GoodsCustomerPriceRepository extends JpaRepository<GoodsCustomerPrice, Long>{
     ...
     * @return
     */
    @Query("from GoodsCustomerPrice w where w.goodsId = ?1 and w.type = com.wanmi.sbc.goods.bean.enums.PriceType.SPU")
     ...
     * @return
     */
    @Query("from GoodsCustomerPrice w where w.goodsInfoId = ?1 and w.type = com.wanmi.sbc.goods.bean.enums.PriceType.SKU")
     ...
     * @return
     */
    @Query("from GoodsCustomerPrice w where w.goodsInfoId in ?1 and w.type = com.wanmi.sbc.goods.bean.enums.PriceType.SKU")
     ...
     * @return
     */
    @Query("from GoodsCustomerPrice w where w.customerId = :customerId and w.goodsInfoId in :goodsInfoIds and w.type = com.wanmi.sbc.goods.bean.enums.PriceType.SKU")
     ...
     */
    @Modifying
    @Query("delete from GoodsCustomerPrice w  where w.goodsId = ?1 and w.type = com.wanmi.sbc.goods.bean.enums.PriceType.SPU")
     ...
     */
    @Modifying
    @Query("delete from GoodsCustomerPrice w  where w.goodsId in ?1 and w.type = com.wanmi.sbc.goods.bean.enums.PriceType.SPU")
     ...
     */
    @Modifying
    @Query("update GoodsCustomerPrice set goodsId = ?1 where goodsId = ?2")
     ...
     */
    @Modifying
    @Query("update GoodsCustomerPrice set goodsInfoId = ?1 where goodsInfoId = ?2")
     ...
     * @return
     */
    @Query("from GoodsCustomerPrice w where w.goodsId = ?1 and w.type = com.wanmi.sbc.goods.bean.enums.PriceType.SKU")
    List<GoodsCustomerPrice> findSkuByGoodsId(String goodsId);
}
