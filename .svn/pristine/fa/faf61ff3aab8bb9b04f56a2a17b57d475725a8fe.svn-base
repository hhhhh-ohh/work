...
public class TradeEmailService {
    ...
    public void sendMail(BaseResponse<EmailConfigQueryResponse> config, List<CustomerEmailVO> toEmailAddress,
                         Trade tradeDetail, String url,Boolean isCredit) {
        ...
        try {
            ...
            if(isCredit){
                html.setContent(buildContentCredit(tradeDetail.getOrderTimeOut(),url), "text/html; charset=utf-8");
            }else{
...
//        props.put("mail.debug", "true");// 设置是否在控制台显示debug信息
    ...
    public String buildContent(Trade trade, String url) {
        ...
        content.append("<html><body style='width: 800px; margin: auto;'>")
                ...
                .append("  <p>财务组：</p>")
                .append("  <p style='margin-left: 35px;'>于")
                .append(dtf.format(trade.getTradeState().getCreateTime()))
                .append("，生成1笔订单，请点击以下链接完成支付:</p>")
                .append("  <p style='margin-left: 35px;'><a href='")
                .append(url)
                .append("'>")
                .append(url)
                .append("</a></p>")
                ...
                .append(trade.getTradePrice().getTotalPrice())
                .append("</td>")
                .append("      </tr>")
                .append("      <tr>")
     ...
     * @return
     */
    public String buildContentCredit(LocalDateTime time, String url) {
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy年MM月dd日 HH:mm:ss");
        url = url + "/credit-online-repayment";
        StringBuilder content = new StringBuilder();
        content.append("<html><body style='width: 800px; margin: auto;'>")
                .append("<div style='padding-bottom: 50px;'>")
                .append("  <p>财务组：</p>")
                .append("  <p style='margin-left: 35px;'>于")
                .append(dtf.format(time))
                .append("，生成1笔待还款订单，请点击以下链接完成支付（10分钟有效）:</p>")
                .append("  <p style='margin-left: 35px;'><a href='")
                .append(url)
                .append("'>")
                .append(url)
