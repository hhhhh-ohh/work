...
public class ReceivableService {
    ...
    public List<Receivable> findByDelFlagAndPayOrderIds(List<String> payOrderIds) {
        return receivableRepository.findByDelFlagAndPayOrderIdIn(DeleteFlag.NO, payOrderIds);
    }
}
