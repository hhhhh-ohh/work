...
public class GrouponActivitySaveController implements GrouponActivitySaveProvider {
     ...
     */
    @Override
    public BaseResponse<GrouponActivityAddResponse> batchCheckMarketing(@RequestBody @Valid GrouponActivityBatchCheckRequest request) {
        GrouponActivityAddResponse grouponActivityAddResponse = grouponActivityService.batchCheckMarketing(request);
        return BaseResponse.success(grouponActivityAddResponse);
    }
    ...
    @Override
    public BaseResponse flushCache(GrouponActivityFlushCacheRequest request) {
        this.grouponActivityService.flushCache(request.getEsGrouponActivityVOList());
        return BaseResponse.SUCCESSFUL();
    }


    @Override
    public BaseResponse closeActivity(@RequestBody @Valid GrouponActivityCloseRequest request) {
        grouponActivityService.close(request.getGrouponActivityId(), request.getStoreId());
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse sycCache() {
        grouponActivityService.sycCache();
        return BaseResponse.SUCCESSFUL();
    }
}
