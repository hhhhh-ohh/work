...
public interface DepartmentProvider {
	...
	BaseResponse<DepartmentByIdResponse> deleteById(@RequestBody @Valid DepartmentDelByIdRequest departmentDelByIdRequest);

	/**
	 * 修改主管
	 *
	 * @author wanggang
	 * @param request 修改主管参数结构 {@link DepartmentModifyLeaderRequest}
	 * @return {@link BaseResponse}
	 */
	@PostMapping("/customer/${application.customer.version}/department/modify-leader")
	 ...
	 * @return
	 */
	@PostMapping("/customer/${application.customer.version}/department/modify-department-employee-num")
	BaseResponse modifyDepartmentEmployeeNum(@RequestBody @Valid ModifyEmployeeNumRequest request);
}
