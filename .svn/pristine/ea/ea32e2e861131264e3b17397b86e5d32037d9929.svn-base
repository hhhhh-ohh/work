 ...
 */
@Tag(name = "GoodsReportController", description = "商品报表 Api")
@RestController
@Validated
...
public class GoodsReportController {
    ...
    public BaseResponse<GoodsReportPageView> skuList(@RequestBody GoodsReportRequest request) {
        try {
            ...
            throw new SbcRuntimeException(CommonErrorCodeEnum.K999999,"查询商品报表异常");
        }
    }
    ...
    public BaseResponse<GoodsReportPageView> cateList(@RequestBody GoodsReportRequest request) {
        try {
            ...
            throw new SbcRuntimeException(CommonErrorCodeEnum.K999999,"查询商品分类报表异常");
        }
    }
    ...
    public BaseResponse<GoodsReportPageView> brandList(@RequestBody GoodsReportRequest request) {
        try {
            ...
            throw new SbcRuntimeException(CommonErrorCodeEnum.K999999,"查询商品品牌报表异常");
        }
    }

    @Operation(summary = "商品总数")
    ...
    public BaseResponse<GoodsTotalView> total(@RequestBody GoodsReportRequest request) {
        try {
            ...
            throw new SbcRuntimeException(CommonErrorCodeEnum.K999999,"查询商品概览异常");
        }
    }
