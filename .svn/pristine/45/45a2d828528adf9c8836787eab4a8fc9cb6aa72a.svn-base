...
public interface StoreGoodsTabRepository extends JpaRepository<StoreGoodsTab, Long>,
     ...
     * @return
     */
    @Query("from StoreGoodsTab where delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and storeId = :storeId ")
     ...
     * @return
     */
    @Query("select max(sort) from StoreGoodsTab where delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and storeId = :storeId ORDER BY sort desc")
