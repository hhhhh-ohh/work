...
public interface DistributionGoodsMatterProvider {
    ...
    BaseResponse<String> add(@RequestBody @Valid DistributionGoodsMatteAddRequest distributionGoodsMatteAddRequest);
     ...
     * 修改商品素材根据storeId
     */
    @PostMapping("/distribution-goods-matter/${application.goods.version}/modifyByStoreId")
    BaseResponse modifyByStoreId(@RequestBody @Valid DistributionGoodsMatterModifyByStoreIdRequest distributionGoodsMatterModifyRequest);
