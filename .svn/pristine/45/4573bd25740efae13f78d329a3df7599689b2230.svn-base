...
public interface SystemResourceCateRepository extends JpaRepository<SystemResourceCate, Long>,
     ...
     */
    @Modifying
    @Query("update SystemResourceCate set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where cateId = ?1")
     ...
     */
    @Modifying
    @Query("update SystemResourceCate set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where cateId in ?1")
