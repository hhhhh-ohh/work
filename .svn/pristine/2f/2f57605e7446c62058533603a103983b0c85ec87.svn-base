...
public interface ProviderTradeProvider {
    ...
    BaseResponse remedySellerRemark(@RequestBody @Valid ProviderTradeRemedyBuyerRemarkRequest providerTradeRemedyBuyerRemarkRequest);
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/provider/trade/confirm-provider-order")
    BaseResponse confirmProviderOrder(@RequestBody @Valid ConfirmProviderOrderRequest request);
}
