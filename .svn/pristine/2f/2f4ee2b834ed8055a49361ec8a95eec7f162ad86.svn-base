...
@Tag(name = "SearchHistoryBaseController", description = "S2B web公用-用户商品搜索历史记录信息API")
public class SearchHistoryBaseController {
    ...
    private final static String REDIS_KEY = CacheKeyConstant.SEARCH_HISTORY_KEY;

    private final static String DISTRIBUTE_SEARCH_HISTORY_KEY = CacheKeyConstant.DISTRIBUTE_SEARCH_HISTORY_KEY;

    /**
     * 搜索拼团商品历史的key
     */
    private final static String GROUPON_SEARCH_HISTORY_KEY = CacheKeyConstant.GROUPON_SEARCH_HISTORY_KEY;

    /**
     * 搜索分销推广商品历史的key
     */
    private final static String DISTRIBUTE_GOODS_SEARCH_HISTORY_KEY = CacheKeyConstant.DISTRIBUTE_GOODS_SEARCH_HISTORY_KEY;
     ...
     * @return BaseResponse<String>
     */
    @Operation(summary = "查询指定店铺内商品的历史记录")
     ...
     * @return BaseResponse
     */
    @Operation(summary = "新增指定店铺内商品的历史记录")
    @Parameter(name = "id", description = "店铺id", required = true)
     ...
     * @return BaseResponse
     */
    @Operation(summary = "清空指定店铺内商品的历史记录")
    @Parameter( name = "id", description = "店铺id", required = true)
    ...
    @Operation(summary = "查询分销员选品商品的历史记录")
    ...
    @Operation(summary = "新增分销员选品商品的历史记录")
    ...
    @Operation(summary = "清空分销员选品商品的历史记录")
    ...
    @Operation(summary = "查询拼团活动商品的历史记录")
    ...
    @Operation(summary = "新增拼团活动商品的历史记录")
    ...
    @Operation(summary = "清空拼团活动商品的历史记录")
    ...
    @Operation(summary = "查询分销推广商品的历史记录")
    ...
    @Operation(summary = "新增分销推广商品的历史记录")
    ...
    @Operation(summary = "清空分销推广商品的历史记录")
