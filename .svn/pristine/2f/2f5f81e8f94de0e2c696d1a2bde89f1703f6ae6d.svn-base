...
public interface EsGoodsInfoElasticProvider {
    ...
    @PostMapping("/elastic/${application.elastic.version}/goods/modify-store")
    BaseResponse modifyStore(@RequestBody @Valid EsGoodsStoreInfoModifyRequest request);

    @PostMapping("/elastic/${application.elastic.version}/goods/modify-goods-property")
    BaseResponse modifyGoodsProperty(@RequestBody @Valid EsGoodsPropertyModifyRequest request);

    @PostMapping("/elastic/${application.elastic.version}/goods/modify-goods-property-index-flag")
    BaseResponse modifyPropIndexFlag(@RequestBody @Valid EsGoodsPropertyIndexRequest request);

    @PostMapping("/elastic/${application.elastic.version}/goods/delete-goods-property")
    BaseResponse deleteGoodsProperty(@RequestBody @Valid EsGoodsPropertyByIdListRequest request);

    @PostMapping("/elastic/${application.elastic.version}/goods/modify-goods-property-sort")
    BaseResponse modifyPropSort(@RequestBody @Valid EsGoodsPropCateSortRequest request);

    @PostMapping("/elastic/${application.elastic.version}/goods/modify-freight-template-id")
    BaseResponse modifyFreightTemplateId(@RequestBody @Valid EsFreightTemplateRequest request);

    @PostMapping("/elastic/${application.elastic.version}/goods/modify-store-name")
    BaseResponse modifyStoreNameByStoreId(@RequestBody @Valid EsGoodsModifyStoreNameByStoreIdRequest request);
}
