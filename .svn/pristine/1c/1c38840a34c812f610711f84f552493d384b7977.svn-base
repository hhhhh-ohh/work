...
public interface CustomerInvoiceProvider {
     ...
     * 删除 增专票信息
     *
     * @param request {@link CustomerInvoiceDeleteOneRequest}
     * @return 删除专票结果 {@link BaseResponse}
     */
    @PostMapping("/customer/${application.customer.version}/invoice/delete-one")
    BaseResponse deleteOne(@RequestBody @Valid CustomerInvoiceDeleteOneRequest request);
    /**
     * 保存增专资质配置
     *
