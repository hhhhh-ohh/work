...
public interface StoreCateQueryProvider {
     ...
     * @return 店铺商品分类集合 {@link StoreCateListByStoreIdResponse }
     */
    @PostMapping("/goods/${application.goods.version}/store/cate/list-by-parent-id")
    BaseResponse<StoreCateListByStoreIdResponse> listByCateParentId(@RequestBody @Valid StoreCateListByParentIdRequest storeCateListByParentIdRequest);
     ...
     * 根据ID获取所有子分类->所有的商品Id
     * @param storeCateListGoodsRelByStoreCateIdAndIsHaveSelfRequest {@link StoreCateListGoodsRelByStoreCateIdAndIsHaveSelfRequest }
     * @return 所有子分类->所有的商品{@link GoodsIdByStoreCateIdAndIsHaveSelfResponse}
     */
    @PostMapping("/goods/${application.goods.version}/store/cate/list-goods-id-by-store-cate-id-and-is-have-self")
    BaseResponse<GoodsIdByStoreCateIdAndIsHaveSelfResponse> listGoodsIdByStoreCateIdAndIsHaveSelf(@RequestBody @Valid StoreCateListGoodsRelByStoreCateIdAndIsHaveSelfRequest storeCateListGoodsRelByStoreCateIdAndIsHaveSelfRequest);

    /**
     * 根据cateIds验证重合
     * @param request 包含cateIds验证重合请求结构 {@link StoreCateCoincideRequest }
     * @return 重合结果 {@link StoreCateCoincideResponse}
     */
    @PostMapping("/goods/${application.goods.version}/store/cate/coincide")
    BaseResponse<StoreCateCoincideResponse> coincide(@RequestBody @Valid StoreCateCoincideRequest request);
}
