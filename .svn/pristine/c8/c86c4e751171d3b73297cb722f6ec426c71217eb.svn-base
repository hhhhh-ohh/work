...
public final class MD5Util {
    ...
    public static byte[] md5(String data, String charset) {
        if (charset == null) {
            ...
            try {
                ...
                LOGGER.info("Calculates MD5 failed; data: {}, charset:{}", data, charset, e);
            }
     ...
     * @return 结果
     */
    public static String md5Hex16(String data, String charset) {
        return md5Hex(data, charset).substring(8, 24);
    }
