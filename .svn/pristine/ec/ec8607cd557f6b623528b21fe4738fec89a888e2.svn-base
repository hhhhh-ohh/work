...
public interface SmsTemplateRepository extends JpaRepository<SmsTemplate, Long>,
     ...
     */
    @Modifying
    @Query("update SmsTemplate set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where id = ?1")
     ...
     */
    @Modifying
    @Query("update SmsTemplate set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where id in ?1")
     ...
     * @author lvzhenwei
     */
    int countAllByTemplateTypeAndDelFlag(SmsType smsType, DeleteFlag deleteFlag);
}
