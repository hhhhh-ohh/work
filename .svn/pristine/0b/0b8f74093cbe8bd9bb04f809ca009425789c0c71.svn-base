...
public interface GrouponActivitySaveProvider {
    ...
    BaseResponse<GrouponActivityAddResponse> batchCheckMarketing(@RequestBody @Valid GrouponActivityBatchCheckRequest request);
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/groupon/activity/flush-cache")
    BaseResponse flushCache(@RequestBody GrouponActivityFlushCacheRequest request);

    /**
     * 关闭拼团活动
     *
     * @param request 请求参数bean {@link GrouponActivityCloseRequest}
     * @return {@link BaseResponse}
     */
    @PostMapping("/marketing/${application.marketing.version}/groupon/activity/close")
    BaseResponse closeActivity(@RequestBody @Valid GrouponActivityCloseRequest request);

    @PostMapping("/marketing/${application.marketing.version}/groupon/activity/syc-cache")
