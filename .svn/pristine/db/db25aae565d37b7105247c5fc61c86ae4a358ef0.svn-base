...
public class EsStandardQueryController implements EsStandardQueryProvider {
    ...
    @Override
    public BaseResponse<Long> count(@RequestBody EsStandardPageRequest request) {
        return BaseResponse.success(esStandardService.count(request));
    }
}
