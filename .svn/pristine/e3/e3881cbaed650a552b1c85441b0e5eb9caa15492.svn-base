...
/**
 * <p>折扣商品与付费会员等级关联表动态查询条件构建器</p>
 * @author zhanghao
 * @date 2022-05-13 13:41:36
 */
public class PayingMemberDiscountRelWhereCriteriaBuilder {
    public static Specification<PayingMemberDiscountRel> build(PayingMemberDiscountRelQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            // 折扣
            if (queryRequest.getDiscount() != null) {
                predicates.add(cbuild.equal(root.get("discount"), queryRequest.getDiscount()));
            }
