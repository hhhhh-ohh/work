...
public class ContractBrandController implements ContractBrandProvider {
    ...
    public BaseResponse<List<GoodsBrandVO>> transferByStoreId(@RequestBody @Valid ContractBrandTransferByStoreIdRequest request){

        return BaseResponse.success(contractBrandService.transfer(request.getStoreId()));
    }
