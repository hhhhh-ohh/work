...
public interface DistributorGoodsInfoProvider {
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/distributor/goods/modify-by-store-id-and-status-for-lakala")
    BaseResponse modifyByStoreIdAndStatusForLaKaLA(@RequestBody @Valid DistributorGoodsInfoModifyByStoreIdAndStatusRequest request);
     ...
     * @param request
     */
    @PostMapping("/goods/${application.goods.version}/distributor/goods/update-status-for-la-ka-la")
    BaseResponse updateStatusForLaKaLa(@RequestBody DistributorGoodsInfoModifyByStoreIdAndCustomerIdRequest request);
}
