...
/**
 * <p>商家消息节点设置动态查询条件构建器</p>
 * @author 马连峰
 * @date 2022-07-11 09:42:56
 */
public class StoreMessageNodeSettingWhereCriteriaBuilder {
    public static Specification<StoreMessageNodeSetting> build(StoreMessageNodeSettingQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            // 消息节点标识
            if (queryRequest.getNodeCode() != null) {
