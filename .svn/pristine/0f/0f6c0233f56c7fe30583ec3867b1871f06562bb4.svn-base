...
@Tag(name = "StoreTobeEvaluateController", description = "S2B web公用-店铺服务待评价API")
public class StoreTobeEvaluateController {
     ...
     * @return
     */
    @Operation(summary = "分页查询待评价店铺服务列表")
    ...
    public BaseResponse<StoreTobeEvaluatePageResponse> pageStoreTobeEvaluate(@RequestBody StoreTobeEvaluatePageRequest
        ...
        storeTobeEvaluatePageReq.setCustomerId(commonUtil.getOperatorId());
