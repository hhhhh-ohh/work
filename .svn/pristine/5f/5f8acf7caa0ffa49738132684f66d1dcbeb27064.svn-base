...
public interface MarketingBuyoutPriceProvider {
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/marketing/${application.marketing.version}/buyout_price/check")
    BaseResponse checkMarketingTimeAndRuleConflict(@RequestBody @Valid MarketingBuyoutPriceAddRequest request);
