...
public interface CompanyInfoQueryProvider {
     ...
     * @return              商家对象
     */
    @PostMapping("/customer/${application.customer.version}/company/query-by-precise-company-info-code")
    BaseResponse<CompanyInfoVO> queryByPreciseCompanyCode(@RequestBody @Valid CompanyInfoForDistributionRecordRequest recordRequest);
}
