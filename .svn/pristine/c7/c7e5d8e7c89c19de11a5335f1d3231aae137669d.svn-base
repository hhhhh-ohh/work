...
public class MarketingPluginQueryController implements MarketingPluginQueryProvider {
    ...
    getByGoodsInfoListAndCustomer(@RequestBody @Valid MarketingPluginByGoodsInfoListAndCustomerRequest request) {
        ...
        Map<String, List<MarketingResponse>> marketing = marketingPluginServiceInterface.getMarketing(voList,
                marketingPluginService.getCustomerLevels(voList, customerId),
                Nutils.defaultVal(request.getPluginType(), PluginType.NORMAL), request.getStoreId(),
                customerId);
