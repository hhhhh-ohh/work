...
public interface PopularSearchTermsRespository extends JpaRepository<PopularSearchTerms,Long>,
     ...
     */
    @Modifying
    @Query(value = "update PopularSearchTerms p set  p.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where id=?1")
     ...
     */
    @Modifying
    @Query(value = "update PopularSearchTerms at set at.sortNumber =:sortNumber,at.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO where at" +
     ...
     * @return
     */
    @Query("select count(1) from PopularSearchTerms c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.id <> ?1 and c.popularSearchKeyword = ?2")
