...
public class PointsCouponSaveController implements PointsCouponSaveProvider {
    ...
    public BaseResponse<PointsCouponAddListResponse> batchAdd(@RequestBody @Valid PointsCouponAddListRequest pointsCouponAddListRequest) {
        ...
        List<String> activityIdList = pointsCouponService.batchAdd(KsBeanUtil.copyListProperties(pointsCouponAddRequestList, PointsCoupon.class));
    ...
    @Override
    public BaseResponse close(@RequestBody @Valid PointsCouponCloseRequest request) {
        pointsCouponService.close(request.getPointsCouponId(), request.getOperateId());
        return BaseResponse.SUCCESSFUL();
    }
