...
public interface DistributionCustomerRepository extends JpaRepository<DistributionCustomer, String>,
    ...
    @Query("update DistributionCustomer c set c.forbiddenFlag = :forbiddenFlag, c.forbiddenReason = :forbidReason where c" +
            ".delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.distributionId in :distributionIds")
     ...
     */
    @Modifying
    @Query("update DistributionCustomer c set c.forbiddenFlag = com.wanmi.sbc.common.enums.DefaultFlag.YES, c" +
            ".forbiddenReason = '用户注销' where c" +
            ".delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.customerId = :customerId")
    void updateForbiddenFlagByCustomerId(@Param("customerId") String customerId);
