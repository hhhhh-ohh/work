...
public class EmployeePerformanceReport implements Serializable {
    ...
    private static final long serialVersionUID = -2780711423304799563L;
    /**
     * 商户id
     */
     ...
     * 付款总金额
     */
    private BigDecimal payAmount = new BigDecimal(0).setScale(2, RoundingMode.HALF_UP);
     ...
     * 退单总金额
     */
    private BigDecimal returnAmount = new BigDecimal(0).setScale(2, RoundingMode.HALF_UP);
     ...
     * 笔单价
     */
    private BigDecimal orderUnitPrice = new BigDecimal(0).setScale(2, RoundingMode.HALF_UP);

    /**
     * 客单价
     */
    private BigDecimal customerUnitPrice = new BigDecimal(0).setScale(2, RoundingMode.HALF_UP);
