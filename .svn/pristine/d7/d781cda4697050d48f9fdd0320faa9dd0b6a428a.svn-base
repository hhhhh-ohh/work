...
@NoArgsConstructor
@AllArgsConstructor
public class SumPayOrderPriceRequest extends BaseQueryRequest {
     ...
     * 在支付渠道
     */
    @Schema(description = "在支付渠道",contentMediaType = "com.wanmi.sbc.pay.api.enums.PayGatewayEnum.class")
