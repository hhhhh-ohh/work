...
@RestController
@Validated
@Tag(name = "SearchAssociationalWordController", description = "搜索词增删改服务API")
...
public class SearchAssociationalWordController {
     ...
     */
    @GlobalTransactional
    @Operation(summary = "修改搜索词")
    @PostMapping("/modify")
    public BaseResponse<SearchAssociationalWordResponse> modify(@RequestBody @Valid SearchAssociationalWordModifyRequest request) {
     ...
     */
    @GlobalTransactional
    @Operation(summary = "删除搜索词")
    @PostMapping("/delete_search_associational_word")
    public BaseResponse deleteSearchAssociationalWord(@RequestBody @Valid SearchAssociationalWordDeleteByIdRequest searchAssociationalWordId) {
        operateLogMQUtil.convertAndSend("搜索词", "删除搜索词", "删除搜索词：" + searchAssociationalWordId.getId());
        //删除es搜索词
        BaseResponse response = searchAssociationalWordProvider.deleteSearchAssociationalWord(searchAssociationalWordId);
        esSearchAssociationalWordProvider.deleteById(EsSearchAssociationalWordDelRequest.builder().id(searchAssociationalWordId.getId()).build());
        return response;
    }
     ...
     * @return
     */
    @Operation(summary = "新增联想词")
    @PostMapping("/add_associational_word")
    public BaseResponse addAssociationalWord(@RequestBody @Valid AssociationLongTailWordRequest request) {
     ...
     * @return
     */
    @Operation(summary = "修改联想词")
    @PostMapping("/modify_associational_word")
    public BaseResponse modifyAssociationalWord(@RequestBody @Valid AssociationLongTailWordModifyRequest request) {
        request.setUpdatePerson(commonUtil.getOperatorId());
     ...
     * @return
     */
    @Operation(summary = "联想词排序")
    @PostMapping("/sort_associational_word")
    public BaseResponse sortAssociationalWord(@RequestBody @Valid List<AssociationLongTailWordSortRequest> request) {
     ...
     * @return
     */
    @Operation(summary = "删除联想词")
    @PostMapping("/delete_associational_long_tail_word")
    public BaseResponse deleteAssociationLongTailWord(@RequestBody @Valid AssociationLongTailWordDeleteByIdRequest associationLongTailWordId) {
