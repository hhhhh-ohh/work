...
public interface DistributorGoodsInfoQueryProvider {
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/distributor/goods/find-froup-by-customer-id-and-store-id")
    BaseResponse<DistributorGoodsInfoListByCustomerIdResponse>  findGroupByCustomerAndStoreId(@RequestBody DistributorGoodsInfoPageByCustomerIdRequest request);
    ...
    BaseResponse validate(@RequestBody @Valid DistributorGoodsInfoValidateRequest request);
}
