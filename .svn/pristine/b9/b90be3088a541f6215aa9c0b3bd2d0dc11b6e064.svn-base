...
@NoArgsConstructor
@AllArgsConstructor
public class CommunityLeaderQueryRequest extends BaseQueryRequest {
	 ...
	 * 批量查询-团长idList
	 */
	@Schema(description = "批量查询-区域团长idList")
	private List<String> areaLeaderIdList;
	...
	/**
	 * 是否查询已审核通过的团长 包括已审核和禁用中
	 */
	@Schema(description = "是否查询已审核通过的团长 0：否  1：是")
	 ...
	 * 非自身的团长id
	 */
	@Schema(description = "非自身的团长id")
	private String notLeaderId;
