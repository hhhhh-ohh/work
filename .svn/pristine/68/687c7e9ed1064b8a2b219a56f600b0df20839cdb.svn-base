...
public class InvoiceProjectQueryController implements InvoiceProjectQueryProvider {
     ...
     */
    @Override
    public BaseResponse<InvoiceProjectByIdResponse> getAllById(@RequestBody @Valid InvoiceProjectByIdRequest invoiceProjectByIdRequest) {
        InvoiceProject invoiceProject = invoiceProjectService.findAllInvoiceProjectById(invoiceProjectByIdRequest.getProjcetId()).orElse(null);
        if (Objects.isNull(invoiceProject)) {
            return BaseResponse.success(new InvoiceProjectByIdResponse());
        }
        InvoiceProjectByIdResponse invoiceProjectByIdResponse = new InvoiceProjectByIdResponse();
