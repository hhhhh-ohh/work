...
import com.wanmi.sbc.empower.bean.vo.sellplatform.goods.PlatformGoodsDescInfoVO;
...
@NoArgsConstructor
@Schema
public class PlatformAddGoodsRequest extends ThirdBaseRequest {
    ...
    private PlatformGoodsDescInfoVO desc_info;
