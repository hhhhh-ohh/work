...
@Tag(name =  "店铺退货地址表管理API", description =  "StoreReturnAddressController")
@RestController
@Validated
...
public class StoreReturnAddressController {
    ...
    @Operation(summary = "根据id查询店铺退货地址表")
    ...
    @Operation(summary = "根据id删除店铺退货地址表")
    @Parameter(name = "addressId", description = "地址ID", required = true)
    @MultiSubmit
