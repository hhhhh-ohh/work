...
@NoArgsConstructor
@AllArgsConstructor
public class LeaderTradeDetailTradeCountGroupByActivityResponse implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * 团长订单列表结果
     */
    @Schema(description = "团长订单列表结果")
    private List<CommunityTradeCountVO> tradeCountList;
}
