...
public class GrouponGoodsInfoQueryController implements GrouponGoodsInfoQueryProvider {
        ...
        if (CollectionUtils.isNotEmpty(newList)) {
            ...
            newList.forEach(item -> {
                ...
                if (params.isPresent()) {
                    ...
                    item.setGoodsType(params.get().getGoodsType());
                }
            });
    ...
    public BaseResponse<GrouponGoodsByGrouponActivityIdAndGoodsInfoIdResponse> getByGrouponActivityIdAndGoodsInfoId(@RequestBody @Valid GrouponGoodsByGrouponActivityIdAndGoodsInfoIdRequest request) {
        ...
        grouponGoodsInfoVO.setGoodsInfo(KsBeanUtil.convert(goodsInfoService.findById2(grouponGoodsInfo.getGoodsInfoId()), GoodsInfoVO.class));
    ...
    @Override
    public BaseResponse<GrouponCountByActivityIdsAndSkuIdsResponse> countByActivityIdsAndSkuIds(@RequestBody @Valid GrouponCountByActivityIdsAndSkuIdsRequest request) {
        Long count = grouponGoodsInfoService.countBySkuIdsByActivityIds(request.getGrouponActivityIdList(), request.getSkuIds());
        return BaseResponse.success(new GrouponCountByActivityIdsAndSkuIdsResponse(count));
    }
}
