...
public class DistributionCommissionService {
     ...
     * @description 查询数量
     * @author  xuyunpeng
     * @date 2021/6/7 2:29 下午
     * @param request
     * @return
     */
    public Long count(DistributionCommissionPageRequest request) {
        return distributionCustomerRepository.count(QueryConditionsUtil.getWhereCriteria(request));
    }
