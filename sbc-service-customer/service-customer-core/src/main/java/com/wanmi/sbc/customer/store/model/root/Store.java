...
import com.wanmi.sbc.common.enums.SupplierType;
...
public class Store implements Serializable {
     ...
     */
    @Column(name = "contract_audit_state")
    private CheckState contractAuditState;

    /**
     * 二次签约拒绝原因
     */
    @Column(name = "contract_audit_reason")
     ...
     * 拉卡拉商户进件状态 0未进件 1已进件
     */
    @Column(name = "lakala_state")
    private Integer lakalaState;


    /**
     * 是否是拉卡拉导致的关店 0 不是  1是
     */
    @Column(name = "lakala_reason")
    private Integer lakalaReason;
