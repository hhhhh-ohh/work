...
public class DistributionCommissionRedisService {
    ...
    public Map<String, Double> afterSupplyAgainUpdate(BigDecimal amout){
        double doubleValue = amout.doubleValue();
        Double commissionTotal = redisService.incrByFloat(DistributionCommissionRedisKey.DISTRIBUTION_COMMISSION_TOTAL,doubleValue);
        Double rewardCash = redisService.incrByFloat(DistributionCommissionRedisKey.DISTRIBUTION_REWARD_CASH, doubleValue);
        Double rewardCashNotRecorded = redisService.decrByFloat(DistributionCommissionRedisKey.DISTRIBUTION_REWARD_CASH_NOTRECORDED, doubleValue);
        return ImmutableMap.of(DistributionCommissionRedisKey.DISTRIBUTION_COMMISSION_TOTAL,commissionTotal,
                DistributionCommissionRedisKey.DISTRIBUTION_REWARD_CASH,rewardCash,
                DistributionCommissionRedisKey.DISTRIBUTION_REWARD_CASH_NOTRECORDED,rewardCashNotRecorded);
    }
