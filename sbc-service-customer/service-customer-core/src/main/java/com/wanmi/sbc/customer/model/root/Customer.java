...
import com.wanmi.sbc.common.util.jpa.LocalDateTimeConverter;
...
public class Customer implements Serializable {
    ...
    /**
     * 支付密码的安全等级: 20危险 40低、60中、80高
     */
    @Column(name = "pay_safe_level")
     ...
     * 支付密码盐值，用于支付密码加密
     */
    @Column(name = "customer_pay_salt_val")
    private String customerPaySaltVal;
...
//    @JsonManagedReference
    ...
    @Transient
    private EnterpriseInfo enterpriseInfoVO;
    ...
    @JsonSerialize(using = CustomLocalDateTimeSerializer.class)
    @JsonDeserialize(using = CustomLocalDateTimeDeserializer.class)
    @Column(name = "membership_expired_time")
    ...
    public void setHeadImg(String headImg) {
        this.headImg = handleWxHeadImg(headImg);
    }

    /**
     * @description   微信图片需要替换掉域名
     * @author  wur
     * @date: 2022/8/4 14:23
     * @param headImg
     * @return
