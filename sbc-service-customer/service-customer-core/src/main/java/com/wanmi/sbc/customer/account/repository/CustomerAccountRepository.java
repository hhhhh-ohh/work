...
public interface CustomerAccountRepository extends JpaRepository<CustomerAccount, String> {
     ...
     * @return
     */
    @Query("from CustomerAccount l where l.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and l.customerId = ?1 order by l.createTime desc")
     ...
     * @return
     */
    @Query("select count(1) from CustomerAccount l where l.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and l.customerId = ?1")
     ...
     */
    @Modifying
    @Query("update CustomerAccount l set l.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES, l.deletePerson=:deletePerson, l.deleteTime=:deleteTime " +
            "where l.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and l.customerAccountId = :customerAccountId")
     ...
     */
    @Modifying
    @Query("update CustomerAccount l set l.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES, l.deletePerson=:customerId, l.deleteTime=:deleteTime " +
            "where l.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and l.customerAccountId = :customerAccountId and l.customerId = :customerId")
     ...
     * @return rows
     */
    @Query("update CustomerAccount c set c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.customerId in :customerIds")
    @Modifying
