...
/**
 * <p>权益与付费会员等级关联表动态查询条件构建器</p>
 * @author zhanghao
 * @date 2022-05-13 13:41:21
 */
public class PayingMemberRightsRelWhereCriteriaBuilder {
    public static Specification<PayingMemberRightsRel> build(PayingMemberRightsRelQueryRequest queryRequest) {
