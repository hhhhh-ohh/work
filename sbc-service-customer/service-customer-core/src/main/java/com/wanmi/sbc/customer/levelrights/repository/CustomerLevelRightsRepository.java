...
public interface CustomerLevelRightsRepository extends JpaRepository<CustomerLevelRights, Integer>,
     ...
     * @return
     */
    @Query("from CustomerLevelRights c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.rightsId = ?1")
     ...
     * @return
     */
    @Query("from CustomerLevelRights c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO order by c.sort,c.createTime")
     ...
     */
    @Modifying
    @Query("update CustomerLevelRights c set c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where c.rightsId = ?1")
