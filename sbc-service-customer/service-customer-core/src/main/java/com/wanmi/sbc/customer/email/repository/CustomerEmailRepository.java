...
public interface CustomerEmailRepository extends JpaRepository<CustomerEmail, Long>,
     ...
     * @return
     */
    @Query("from CustomerEmail c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.customerEmailId <> ?1 and c.customerId = ?2 " +
     ...
     * @param delTime
     */
    @Query("update CustomerEmail c set c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES, c.delPerson = ?2, c.delTime = ?3 where c.customerEmailId = ?1")
    @Modifying
