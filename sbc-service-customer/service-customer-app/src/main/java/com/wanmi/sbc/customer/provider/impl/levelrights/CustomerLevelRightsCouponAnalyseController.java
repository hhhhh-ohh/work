...
public class CustomerLevelRightsCouponAnalyseController implements CustomerLevelRightsCouponAnalyseProvider {
    ...
    @Override
    public BaseResponse<CustomerLevelRightsListResponse> queryRepeatCouponsData(@Valid @RequestBody CustomerLevelRightsRepeatRequest request) {
        return BaseResponse.success(customerLevelRightsCouponAnalyseService.queryRepeatCouponsData(request.getType()));
    }
}
