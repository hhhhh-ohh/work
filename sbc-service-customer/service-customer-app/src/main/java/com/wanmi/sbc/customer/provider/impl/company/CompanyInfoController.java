...
public class CompanyInfoController implements CompanyInfoProvider {
    ...
    public BaseResponse<CompanyInformationModifyResponse> modifyCompanyInformation(@RequestBody CompanyInformationSaveRequest request) {
        ...
        return BaseResponse.success(KsBeanUtil.copyPropertiesThird(companyInfo,CompanyInformationModifyResponse.class));
    }
    ...
    public BaseResponse modifyBusinessLicence(@RequestBody @Valid CompanyInfoModifyBusinessLicenceRequest request) {
        companyInfoService.modifyBusinessLicence(request);
        return BaseResponse.SUCCESSFUL();
    }
}
