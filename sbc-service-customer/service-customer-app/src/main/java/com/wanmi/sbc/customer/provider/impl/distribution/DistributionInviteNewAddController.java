...
public class DistributionInviteNewAddController implements DistributionInviteNewProvider {
     ...
     */
    @Override
    public BaseResponse<DistributionInviteNewRecordVO> updateBySupplyAgain(@RequestBody @Valid DistributionInviteNewSupplyAgainRequest request) {
        DistributionInviteNewRecordVO vo = customerDistributionInviteNewService.updateBySupplyAgain(request);
        return BaseResponse.success(vo);
    }
     ...
     */
    @Override
    public BaseResponse<DistributionInviteNewSaveResponse> addRegister(@RequestBody @Valid DistributionInviteNewAddRegisterRequest request) {
        DistributionInviteNewSaveResponse distributionInviteNewSaveResponse = customerDistributionInviteNewService.addDistributionInviteNewRecord(request);
        return BaseResponse.success(distributionInviteNewSaveResponse);
    }
