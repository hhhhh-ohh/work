...
public class CustomerInvoiceQueryController implements CustomerInvoiceQueryProvider {
    ...
    public BaseResponse<CustomerInvoicePageResponse> page(@RequestBody @Valid CustomerInvoicePageRequest customerInvoicePageRequest) {
        ...
        List<CustomerInvoiceVO> customerInvoiceVOList = KsBeanUtil.convertList(customerInvoiceResponseBaseQueryResponse.getData(),CustomerInvoiceVO.class);
    ...
    public BaseResponse<CustomerInvoiceByCustomerIdAndDelFlagAndCheckStateResponse> getByCustomerIdAndDelFlagAndCheckState(@RequestBody @Valid CustomerInvoiceByCustomerIdAndDelFlagAndCheckStateRequest customerInvoiceByCustomerIdRequest) {
        List<CustomerInvoice> customerInvoice = customerInvoiceService.findByCustomerIdAndCheckState(customerInvoiceByCustomerIdRequest.getCustomerId());
        ...
        if (CollectionUtils.isEmpty(customerInvoice)){
            return BaseResponse.SUCCESSFUL();
        }
        KsBeanUtil.copyPropertiesThird(customerInvoice.get(0),customerInvoiceByCustomerIdAndDelFlagAndCheckStateResponse);
...
//        List<CustomerInvoice> customerInvoice = customerInvoiceService.findByCustomerIdAndCheckState(customerInvoiceByCustomerIdAndCheckStateRequest.getCustomerId());
...
//    }
    ...
    @Override
    public BaseResponse<CustomerInvoiceListResponse> getByCustomerIdAndDelFlag(@RequestBody @Valid CustomerInvoiceByCustomerIdAndDelFlagRequest customerInvoiceByCustomerIdRequest) {
        List<CustomerInvoice> customerInvoice = customerInvoiceService.findCustomerInvoiceByCustomerId(customerInvoiceByCustomerIdRequest.getCustomerId());
        return BaseResponse.success(CustomerInvoiceListResponse.builder().customerInvoiceVOList(KsBeanUtil.convert(customerInvoice,CustomerInvoiceVO.class)).build());
    }

    @Override
    public BaseResponse<CustomerInvoiceByCustomerIdAndDelFlagResponse> getSpecialByCustomerIdAndDelFlag(@RequestBody @Valid CustomerInvoiceByCustomerIdAndDelFlagRequest customerInvoiceByCustomerIdRequest) {
        List<CustomerInvoice> customerInvoice = customerInvoiceService.findByCustomerIdAndInvoiceStyle(customerInvoiceByCustomerIdRequest.getCustomerId(), InvoiceStyle.SPECIAL);
        ...
        KsBeanUtil.copyPropertiesThird(customerInvoice.get(0),customerInvoiceByCustomerIdAndDelFlagResponse);
        return BaseResponse.success(customerInvoiceByCustomerIdAndDelFlagResponse);
    }

    @Override
    public BaseResponse<CustomerInvoiceListResponse> getByCustomerIdAndDelFlagAndStyle(@RequestBody @Valid CustomerInvoiceByCustomerIdAndDelFlagRequest request) {
        List<CustomerInvoice> customerInvoice = customerInvoiceService.findByCustomerIdAndInvoiceStyle(request.getCustomerId(), request.getInvoiceStyle());
    ...
    public BaseResponse<CustomerInvoiceByCustomerIdResponse> getByCustomerId(@RequestBody @Valid CustomerInvoiceByCustomerIdRequest customerInvoiceByCustomerIdRequest) {
        CustomerInvoiceInfoResponse customerInvoiceInfoResponse = customerInvoiceService.findSpecialByCustomerId(customerInvoiceByCustomerIdRequest.getCustomerId());
    ...
    public BaseResponse<CustomerInvoiceByTaxpayerNumberResponse> getByTaxpayerNumber(@RequestBody @Valid CustomerInvoiceByTaxpayerNumberRequest customerInvoiceByTaxpayerNumberRequest) {
        CustomerInvoice customerInvoice = customerInvoiceService.findByTaxpayerNumberAndDelFlag(customerInvoiceByTaxpayerNumberRequest.getTaxpayerNumber(),customerInvoiceByTaxpayerNumberRequest.getUserId()).orElse(null);
        if (Objects.isNull(customerInvoice)){
            return BaseResponse.SUCCESSFUL();
        }
