...
public class CustomerDetailQueryController implements CustomerDetailQueryProvider {
    ...
    @Override
    public BaseResponse<CustomerDetailListByConditionResponse> listCustomerDetailByAgentUniqueCode(CustomerDetailListByAgentUniqueCodeRequest request) {
        CustomerDetailListByConditionResponse response = new CustomerDetailListByConditionResponse();
        List<CustomerDetail> customerDetailList = customerDetailService.findByAgentUniqueCode(request.getAgentUniqueCode());
        response.setCustomerDetailVOList(wraperVos(customerDetailList));
        return BaseResponse.success(response);
    }
}
