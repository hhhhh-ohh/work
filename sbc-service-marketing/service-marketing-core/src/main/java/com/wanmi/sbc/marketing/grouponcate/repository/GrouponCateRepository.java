...
public interface GrouponCateRepository extends JpaRepository<GrouponCate, String>,
     ...
     * @return
     */
    @Query(" from GrouponCate c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO order by c.defaultCate desc, c.cateSort asc, c.createTime desc")
     ...
     * @return
     */
    @Query("select count(1) from GrouponCate c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.grouponCateId <> ?1 and c.grouponCateName = ?2")
