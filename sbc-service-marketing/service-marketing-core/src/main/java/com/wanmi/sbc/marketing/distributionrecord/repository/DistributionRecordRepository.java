...
public interface DistributionRecordRepository extends JpaRepository<DistributionRecord, String>,
     ...
     */
    @Modifying
    @Query("update DistributionRecord dr set dr.missionReceivedTime = :receivedTime ,dr.commissionState = com.wanmi" +
            ".sbc.marketing.bean.enums.CommissionReceived.RECEIVED where " +
     ...
     */
    @Modifying
    @Query("update DistributionRecord dr set dr.deleteFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES,dr" +
            ".orderGoodsCount = 0 where dr.tradeId = :tradeId")
