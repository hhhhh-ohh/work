...
//        sb.append("       ((case when b.booking_type=0 then a.hand_sel_count else a.pay_count end) + good.sham_sales_num) as `goodsSalesNum` ");
        sb.append("       (case when b.booking_type=0 then a.hand_sel_count else a.pay_count end)  as `goodsSalesNum` ");
        return sb.toString();
    }
...
//                    return "order by good.sort_no desc, start_time desc ";
        ...
        StringBuilder sb = new StringBuilder();
//        sb.append("order by a.hand_sel_count desc, b.start_time desc ");
        return sb.toString();
    }
