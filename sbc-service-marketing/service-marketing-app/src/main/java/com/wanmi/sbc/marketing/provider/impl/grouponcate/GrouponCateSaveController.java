...
public class GrouponCateSaveController implements GrouponCateSaveProvider {
    ...
    @Override
    public BaseResponse<GrouponCateDelResponse> deleteById(@RequestBody @Valid GrouponCateDelByIdRequest grouponCateDelByIdRequest) {
        GrouponCate grouponCate = new GrouponCate();
        KsBeanUtil.copyPropertiesThird(grouponCateDelByIdRequest, grouponCate);

        return BaseResponse.success(new GrouponCateDelResponse(grouponCateService.deleteById(grouponCate)));
    }
