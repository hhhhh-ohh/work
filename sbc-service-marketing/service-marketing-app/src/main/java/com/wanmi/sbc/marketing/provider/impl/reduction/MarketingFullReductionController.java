...
import com.wanmi.sbc.marketing.reduction.service.MarketingFullReductionServiceInterface;
...
public class MarketingFullReductionController implements MarketingFullReductionProvider {
    ...
    @Autowired
    private MarketingFullReductionServiceInterface marketingFullReductionServiceInterface;
    ...
    public BaseResponse add(@RequestBody @Valid MarketingFullReductionAddRequest request) {
        marketingFullReductionServiceInterface.addMarketingFullReduction(
                KsBeanUtil.convert(request, MarketingFullReductionSaveRequest.class));
    ...
    public BaseResponse modify(@RequestBody @Valid MarketingFullReductionModifyRequest request) {
        marketingFullReductionServiceInterface.modifyMarketingFullReduction(
                KsBeanUtil.convert(request, MarketingFullReductionSaveRequest.class));
        return BaseResponse.SUCCESSFUL();
    }
