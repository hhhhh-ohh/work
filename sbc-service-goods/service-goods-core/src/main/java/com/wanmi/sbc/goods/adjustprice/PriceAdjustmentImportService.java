...
public class PriceAdjustmentImportService {
    ...
    @Value("classpath:/download/adjust_marketing_price_template.xlsx")
    private Resource marketingPriceTemplateFile;

    @Value("classpath:/download/adjust_supply_price_template.xlsx")
    private Resource supplyPriceTemplateFile;

    @Value("classpath:/download/adjust_level_price_template.xlsx")
    private Resource customerLevelPriceTemplateFile;

    @Value("classpath:/download/adjust_interval_price_template.xlsx")
    private Resource intervalPriceTemplateFile;

    /***
     * 批量调整库存模板
     */
    @Value("classpath:/download/adjust_o2o_inventory_template.xlsx")
    private Resource o2oInventoryTemplateFile;

    /***
     * 门店市场价调整模板
     */
    @Value("classpath:/download/o2o_adjust_marketing_price_template.xlsx")
    private Resource o2oMarketingPriceTemplateFile;
    ...
    public String exportAdjustmentPriceTemplate(PriceAdjustmentType type, Long storeId) {
        ...
        switch (type) {
            ...
            case STOCK:
                ...
                break;
            case INVENTORY:
                resource = o2oInventoryTemplateFile;
                break;
            case O2O_MARKET:
                resource = o2oMarketingPriceTemplateFile;
                break;
            default:
