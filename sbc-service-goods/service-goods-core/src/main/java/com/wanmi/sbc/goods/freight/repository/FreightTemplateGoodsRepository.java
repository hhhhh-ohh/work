...
public interface FreightTemplateGoodsRepository extends JpaRepository<FreightTemplateGoods, Long> {
    ...
    @Query(value = "from FreightTemplateGoods a where a.storeId = ?1 and a.defaultFlag = com.wanmi.sbc.common.enums.DefaultFlag.YES and a.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO")
     ...
     * @return
     */
    @Query("from FreightTemplateGoods f where f.freightTempId = :freightTempId and f.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO")
     ...
     * @return
     */
    @Query("from FreightTemplateGoods f where f.storeId = :storeId and f.freightTempName = :freightTempName and f.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO")
