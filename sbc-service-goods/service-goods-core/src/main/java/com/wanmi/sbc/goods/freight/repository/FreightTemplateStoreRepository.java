...
public interface FreightTemplateStoreRepository extends JpaRepository<FreightTemplateStore, Long>, JpaSpecificationExecutor<FreightTemplateStore> {
     ...
     * @return
     */
    @Query("from FreightTemplateStore f where f.freightTempId = :freightTempId and f.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO")
     ...
     * @return
     */
    @Query("from FreightTemplateStore f where f.storeId = :storeId and f.freightTempName = :freightTempName and f.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO")
