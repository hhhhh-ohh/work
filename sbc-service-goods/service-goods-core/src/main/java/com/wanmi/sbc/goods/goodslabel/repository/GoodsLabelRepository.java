...
public interface GoodsLabelRepository extends JpaRepository<GoodsLabel, Long>,
     ...
     */
    @Modifying
    @Query("update GoodsLabel set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where goodsLabelId = ?1 and storeId = ?2")
     ...
     */
    @Modifying
    @Query("update GoodsLabel set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where goodsLabelId in ?1 and storeId = ?2")
