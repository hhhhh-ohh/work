...
public interface PriceAdjustmentRecordDetailRepository extends JpaRepository<PriceAdjustmentRecordDetail, Long>,
    ...
    @Modifying
    @Query(value = "delete from PriceAdjustmentRecordDetail r where r.priceAdjustmentNo in ?1 and r.confirmFlag = com.wanmi.sbc.common.enums.DefaultFlag.NO")
    ...
    @Query(value = "from PriceAdjustmentRecordDetail d where d.goodsInfoId in ?1 and d.confirmFlag = com.wanmi.sbc.common.enums.DefaultFlag.YES and d.auditStatus = 0")
    List<PriceAdjustmentRecordDetail> findByGoodsInfoIds(List<String> goodsInfoIds);
}
