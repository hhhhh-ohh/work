    ...
    public Specification<StandardSku> getWhereCriteria() {
        return (root, cquery, cbuild) -> {
            ...
            if(StringUtils.isNotBlank(thirdPlatformSpuId)){
                predicates.add(cbuild.notEqual(root.get("thirdPlatformSpuId"), thirdPlatformSpuId));
            }
            // 三方SKU ID
            if(StringUtils.isNotBlank(thirdPlatformSkuId)){
                predicates.add(cbuild.notEqual(root.get("thirdPlatformSkuId"), thirdPlatformSkuId));
            }
