...
public interface StandardImageRepository extends JpaRepository<StandardImage, Long>{
     ...
     * @return 商品图片信息
     */
    @Query("from StandardImage w where w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and w.goodsId = ?1")
     ...
     * @return 商品图片信息
     */
    @Query("from StandardImage w where w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and w.goodsId in ?1")
     ...
     */
    @Modifying
    @Query("update StandardImage w set w.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES ,w.updateTime = now() where w.goodsId = ?1")
