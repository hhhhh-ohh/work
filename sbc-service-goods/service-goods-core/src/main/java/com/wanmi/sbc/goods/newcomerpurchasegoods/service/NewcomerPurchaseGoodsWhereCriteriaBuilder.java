 ...
 */
public class NewcomerPurchaseGoodsWhereCriteriaBuilder {
    public static Specification<NewcomerPurchaseGoods> build(NewcomerPurchaseGoodsQueryRequest queryRequest) {
