...
public interface GoodsMarketingRepository extends JpaRepository<GoodsMarketing, String>,
     ...
     * @return
     */
    GoodsMarketing queryByCustomerIdAndGoodsInfoId(String customerId, String goodsInfoId);

    List<GoodsMarketing> queryByCustomerIdAndGoodsInfoIdIn(String customerId, List<String> goodsInfoId);

    List<GoodsMarketing> queryByCustomerIdAndMarketingIdIn(String customerId, List<Long> marketingId);
}
