...
public class PointsGoodsSaveController implements PointsGoodsSaveProvider {
    ...
    @Override
    public BaseResponse modifyStatusByStoreId(@RequestBody @Valid PointsGoodsModifyStatusByStoreIdRequest request) {
        pointsGoodsService.modifyStatusByStoreId(request.getStoreId(), request.getStatus());
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse closeById(@RequestBody @Valid PointsGoodsCloseRequest request) {
        pointsGoodsService.modifyEndTime(request.getPointsGoodsId());
        return BaseResponse.SUCCESSFUL();
    }
}
