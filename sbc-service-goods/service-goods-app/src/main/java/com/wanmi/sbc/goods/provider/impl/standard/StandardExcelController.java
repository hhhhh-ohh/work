...
public class StandardExcelController implements StandardExcelProvider {
     ...
     */
    @Override
    public BaseResponse<StandardExcelExportTemplateResponse> exportTemplate(@RequestBody @Valid StandardGoodsExportRequest request) {
        return BaseResponse.success(StandardExcelExportTemplateResponse.builder()
                .file(standardExcelService.exportTemplate(request.getGoodsType())).build());
    }
}
