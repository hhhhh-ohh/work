...
public class GoodsMarketingQueryController implements GoodsMarketingQueryProvider {
    ...
    @Override
    public BaseResponse<ListByCustomerIdAndMarketingIdResp> listByCustomerIdAndMarketingId(@RequestBody @Valid ListByCustomerIdAndMarketingIdReq request) {
        List<GoodsMarketing> goodsMarketingList = goodsMarketingService.queryByCustomerIdAndMarketingId(request);
        List<GoodsMarketingVO> goodsMarketingVOList = KsBeanUtil.convertList(goodsMarketingList, GoodsMarketingVO.class);
        return BaseResponse.success(ListByCustomerIdAndMarketingIdResp.builder()
                .goodsMarketings(goodsMarketingVOList).build());
    }

    @Override
    public BaseResponse<ListByCustomerIdAndGoodsInfoIdResp> queryByCustomerIdAndGoodsInfoId(@RequestBody @Valid ListByCustomerIdAndGoodsInfoIdReq request) {
        List<GoodsMarketing> goodsMarketingList = goodsMarketingService.queryByCustomerIdAndGoodsInfoId(request);
        List<GoodsMarketingVO> goodsMarketingVOList = KsBeanUtil.convertList(goodsMarketingList, GoodsMarketingVO.class);
        return BaseResponse.success(ListByCustomerIdAndGoodsInfoIdResp.builder()
                .goodsMarketings(goodsMarketingVOList).build());
    }
}
