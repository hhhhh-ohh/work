...
@NoArgsConstructor
@AllArgsConstructor
public class PayTimeSeriesQueryRequest extends BaseQueryRequest {
	private static final long serialVersionUID = -1408769682233366991L;
