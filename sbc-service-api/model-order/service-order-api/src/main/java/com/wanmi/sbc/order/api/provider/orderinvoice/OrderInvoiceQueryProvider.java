...
public interface OrderInvoiceQueryProvider {
     ...
     * 查询数量
     * @param request  {@link OrderInvoiceFindAllRequest}
     * @return  开票信息 {@link Long}
     */
    @PostMapping("/order/${application.order.version}/invoice/count")
    BaseResponse<Long> count(@RequestBody @Valid  OrderInvoiceFindAllRequest request);
