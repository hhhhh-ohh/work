...
public interface PointsTradeQueryProvider {
     ...
     * @return 验证结果 {@link TradeListExportResponse}
     */
    @PostMapping("/points/order/${application.order.version}/points-trade/count-points-trade-export")
    BaseResponse<Long> countPointsTradeExport(@RequestBody @Valid PointsTradeListExportRequest pointsTradeListExportRequest);
