...
public interface ThirdPlatformTradeProvider {
     ...
     * 根据业务id重新新增第三方渠道订单
     *
     * @param request 请求信息 {@link ThirdPlatformTradeReAddRequest}
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/third-platform-trade/re-add")
    BaseResponse reAdd(@RequestBody @Valid ThirdPlatformTradeReAddRequest request);
}
