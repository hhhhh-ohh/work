...
public interface TradeSettingProvider {
    ...
    */
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/order-auto-receive-send-mini-program-msg")
    BaseResponse orderAutoReceiveSendMiniProgramMsg();

    /**
     * 订单业绩自动结账
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/order-performance-auto-settle")
    BaseResponse modifyOrderPerformanceAutoSettle();
}
