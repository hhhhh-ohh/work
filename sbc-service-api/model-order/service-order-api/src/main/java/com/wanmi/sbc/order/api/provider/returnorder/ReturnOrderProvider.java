...
public interface ReturnOrderProvider {
    ...
    BaseResponse<String> refundOnlineByTid(@RequestBody @Valid ReturnOrderOnlineRefundByTidRequest request);
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/return/remedySellerRemark")
    BaseResponse remedySellerRemark(@RequestBody @Valid ReturnOrderRemedySellerRemarkRequest request);
     ...
     * @return 是否通过
     */
    @PostMapping("/order/${application.order.version}/return/check-batch-audit-return-order")
    BaseResponse checkBatchAuditReturnOrder(@RequestBody @Valid ReturnOrderCheckRequest request);
    /**
     * 根据供应商订单id自动退款
     *
     * @param request 供应商订单id请求结构 {@link ReturnOrderAutoReturnByProviderTradeIdRequest}
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/return/auto-return-by-provider-order-id")
    BaseResponse autoReturnByProviderOrderId(@RequestBody @Valid ReturnOrderAutoReturnByProviderTradeIdRequest request);
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/return/send-fast-refund-message")
    BaseResponse sendFastRefundMessage(@RequestBody @Valid ReturnOrderOnlineRefundByTidRequest request);
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/return/do-fast-refund")
    BaseResponse doFastRefund(@RequestBody @Valid ReturnOrderOnlineRefundByTidRequest request);
}
