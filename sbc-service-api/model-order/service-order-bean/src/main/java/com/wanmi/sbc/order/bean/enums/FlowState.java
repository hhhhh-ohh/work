...
public enum FlowState {
    ...
    @ApiEnumProperty("12: CANCEL_DELIVERED 取消发货")
    CANCEL_DELIVERED("CANCEL_DELIVERED", "取消发货"),

    @ApiEnumProperty("13: AVAILABLE_ORDER 有效邀新订单")
    AVAILABLE_ORDER("AVAILABLE_ORDER", "有效邀新订单");
