...
@AllArgsConstructor
@NoArgsConstructor
public class DistributionInviteNewListRequest extends BaseQueryRequest {
     ...
     * 奖励是否入账 0:否 1:是
     */
    @Schema(description = "奖励是否入账", contentSchema = com.wanmi.sbc.customer.bean.enums.CheckState.class)
    private InvalidFlag isRewardRecorded;
