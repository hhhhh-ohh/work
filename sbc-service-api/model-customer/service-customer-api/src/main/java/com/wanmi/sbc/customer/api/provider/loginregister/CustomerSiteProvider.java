...
public interface CustomerSiteProvider {
     ...
     * @return 会员注册结果 {@link CustomerBatchRegisterResponse}
     */
    @PostMapping("/customer/${application.customer.version}/batch-register")
    BaseResponse<CustomerBatchRegisterResponse> batchRegister(@RequestBody @Valid CustomerBatchRegisterRequest registerRequest);
