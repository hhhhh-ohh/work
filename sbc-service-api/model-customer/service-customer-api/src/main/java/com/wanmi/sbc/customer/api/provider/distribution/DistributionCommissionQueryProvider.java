...
public interface DistributionCommissionQueryProvider {
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/distribution/commission/export/count")
    BaseResponse<Long> countForExport(@RequestBody @Valid DistributionCommissionExportRequest request);
