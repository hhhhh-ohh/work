...
import com.wanmi.sbc.customer.api.response.store.InitStoreByCompanyResponse;
import com.wanmi.sbc.customer.api.response.store.StoreAddResponse;
import com.wanmi.sbc.customer.api.response.store.StoreAuditResponse;
import com.wanmi.sbc.customer.api.response.store.StoreContractModifyResponse;
import com.wanmi.sbc.customer.api.response.store.StoreModifyResponse;
...
public interface StoreProvider {
     ...
     * 修改店铺自提状态
     *
     * @param request  {@link StorePickupStateModifyRequest}
     * @return {@link BaseResponse}
     */
    @PostMapping("/customer/${application.customer.version}/store/modify-pickup-state")
    BaseResponse modifyPickupState(@RequestBody @Valid StorePickupStateModifyRequest request);
     ...
     * @param request 门店类型
     */
    @PostMapping("/customer/${application.customer.version}/store/close-pickup-setting")
    BaseResponse closePickupSetting(@RequestBody @Valid ClosePickupSettingRequest request);
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/store/update-contract-state")
    BaseResponse updateContractAuditState(@RequestBody @Valid StoreContractAuditRequest request);
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/store/close-store-for-lakala")
    BaseResponse closeStoreForLaKaLa();
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/store/open-store-for-lakala")
    BaseResponse openStoreForLaKaLa();
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/store/updateLaKaLaState")
    BaseResponse updateLaKaLaState(@RequestBody @Valid StoreByCompanyInfoIdRequest storeByCompanyInfoIdRequest);
