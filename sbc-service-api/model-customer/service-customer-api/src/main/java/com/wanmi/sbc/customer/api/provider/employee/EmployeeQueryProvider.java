...
public interface EmployeeQueryProvider {
    ...
    /**
     * 根据手机号查询不含AccountType
     *
     * @param employeeByPhoneRequest {@link EmployeeByPhoneRequest}
     * @return 员工是否存在 {@link EmployeeByMobileResponse}
     */
    @PostMapping("/customer/${application.customer.version}/employee/get-by-phone")
    BaseResponse<EmployeeByMobileResponse> getByPhone(@RequestBody @Valid
                                                              EmployeeByPhoneRequest employeeByPhoneRequest);
     ...
     * 根据商家编号查询
     *
     * @param request {@link EmployeeSimpleByCompanyIdRequest}
     * @return 员工信息 {@link EmployeeSimpleByCompanyIdResponse}
     */
    @PostMapping("/customer/${application.customer.version}/employee/get-simple-by-company-id")
    BaseResponse<EmployeeSimpleByCompanyIdResponse> getSimpleByCompanyId(
     ...
     * 判断登录用户是否具备这些功能
     *
     * @param request {@link EmployeeFindTodoFunctionIdsRequest}
     * @return 员工ID集合 {@link EmployeeFindTodoFunctionIdsResponse}
     */
    @PostMapping("/customer/${application.customer.version}/employee/find-todo-function-ids")
    BaseResponse<EmployeeFindTodoFunctionIdsResponse> findTodoFunctionIds(@RequestBody @Valid EmployeeFindTodoFunctionIdsRequest request);
}
