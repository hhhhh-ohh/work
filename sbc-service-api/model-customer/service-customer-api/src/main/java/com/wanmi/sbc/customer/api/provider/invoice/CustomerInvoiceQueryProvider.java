...
//                                                                                                        CustomerInvoiceByCustomerIdAndCheckStateRequest customerInvoiceByCustomerIdAndCheckStateRequest);
    ...
    BaseResponse<CustomerInvoiceListResponse> getByCustomerIdAndDelFlag(@RequestBody @Valid CustomerInvoiceByCustomerIdAndDelFlagRequest customerInvoiceByCustomerIdRequest);
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/invoice/get-special-by-customer-id-and-del-flag")
    BaseResponse<CustomerInvoiceByCustomerIdAndDelFlagResponse> getSpecialByCustomerIdAndDelFlag(@RequestBody @Valid CustomerInvoiceByCustomerIdAndDelFlagRequest customerInvoiceByCustomerIdRequest);
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/invoice/get-special-by-customer-id-and-del-flag-and-style")
    BaseResponse<CustomerInvoiceListResponse> getByCustomerIdAndDelFlagAndStyle(@RequestBody @Valid CustomerInvoiceByCustomerIdAndDelFlagRequest request);
        /**
         * 根据用户ID查询是否有会员增票资质
         * @param customerInvoiceByCustomerIdRequest
         * @return
