...
public interface DistributionInviteNewQueryProvider {
     ...
     * @return
     */
    @PostMapping("/customer/${application.customer.version}/distribution/count")
    BaseResponse<Long> countForExport(@RequestBody @Valid DistributionInviteNewExportRequest request);
}
