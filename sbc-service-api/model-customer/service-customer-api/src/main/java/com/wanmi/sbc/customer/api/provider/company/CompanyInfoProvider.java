...
public interface CompanyInfoProvider {
     ...
     *
     * @author lq
     * @param CompanyInfoModifyBusinessLicenceRequest 公司营业执照修改参数结构 {@link CompanyInfoModifyRequest}
     */
    @PostMapping("/setting/${application.setting.version}/companyinfo/modify-businesslicence")
    BaseResponse modifyBusinessLicence(@RequestBody @Valid CompanyInfoModifyBusinessLicenceRequest request);
}
