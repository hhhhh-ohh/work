...
import com.wanmi.sbc.customer.api.request.employee.EmployeeLoginErrorCountModifyByIdRequest;
import com.wanmi.sbc.customer.api.request.employee.EmployeeLoginLockTimeModifyByIdRequest;
import com.wanmi.sbc.customer.api.request.employee.EmployeeLoginTimeModifyByIdRequest;
...
public interface EmployeeProvider {
    ...
    BaseResponse<List<String>> handoverEmployee(@RequestBody @Valid EmployeeHandoverRequest request);
    ...
    BaseResponse<EmployeeActivateAccountResponse> activateAccount(@RequestBody @Valid EmployeeActivateAccountRequest request);
     ...
     * 0点执行登录次数清0操作
     */
    @PostMapping("/customer/${application.customer.version}/employee/modify-login-error-time")
