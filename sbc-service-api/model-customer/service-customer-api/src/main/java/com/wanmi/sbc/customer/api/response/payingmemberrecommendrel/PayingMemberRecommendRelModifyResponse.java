...
@NoArgsConstructor
@AllArgsConstructor
public class PayingMemberRecommendRelModifyResponse implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * 已修改的推荐商品与付费会员等级关联表信息
     */
    @Schema(description = "已修改的推荐商品与付费会员等级关联表信息")
