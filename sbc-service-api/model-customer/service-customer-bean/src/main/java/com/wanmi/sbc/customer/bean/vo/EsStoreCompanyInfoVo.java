...
@Data
@Schema
public class EsStoreCompanyInfoVo extends BasicResponse {
    ...
    public EsStoreCompanyInfoVo convertFromNativeSQLResult(Object result) {
        ...
        BigInteger bigInteger = new BigInteger(((Object[]) result)[0].toString());
        Integer integerValue = bigInteger.intValue();
        response.setCompanyInfoId(integerValue.longValue());
        ...
        response.setRemitAffirm(((Byte)((Object[]) result)[8]).intValue() != 0);
