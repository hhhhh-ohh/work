...
public interface PlatformAddressSaveProvider {
	 ...
	 */
	@PostMapping("/setting/${application.setting.version}/platformaddress/init-pinyin")
	BaseResponse<PlatformAddressListResponse> initPinYin();
	 ...
	 */
	@PostMapping("/setting/${application.setting.version}/platformaddress/batchAdd")
	BaseResponse batchAdd(@RequestBody @Valid PlatformAddressBatchAddRequest platformAddressBatchAddRequest);
}
