...
public interface YunServiceProvider {
     ...
     * @author yang
     */
    @PostMapping("/setting/${application.setting.version}/yunconfig/save-upload-resource")
    BaseResponse<YunUploadResourceResponse> saveUploadedFile(@RequestBody @Valid YunUploadResourceRequest yunUploadResourceRequest);
}
