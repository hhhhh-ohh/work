...
import com.wanmi.sbc.setting.api.request.baseconfig.*;
...
public interface BaseConfigSaveProvider {
	 ...
	 * @return
	 */
	@PostMapping("/setting/${application.setting.version}/baseconfig/modify-agreement")
	BaseResponse modifyAgreement(@RequestBody BaseConfigUpdateRequest request);
