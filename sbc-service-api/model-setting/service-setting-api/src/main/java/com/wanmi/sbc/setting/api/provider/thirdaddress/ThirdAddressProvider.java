...
public interface ThirdAddressProvider {
	...
	/**
	 * @description 第三方地址映射[修正]
	 * @author malianfeng
	 * @date 2023/2/22 15:31
	 * @param request
	 * @return com.wanmi.sbc.common.base.BaseResponse
	 */
	@PostMapping("/setting/${application.setting.version}/thirdaddress/mapping-revise-by-type")
	BaseResponse mappingRevise(@RequestBody @Valid ThirdAddressMappingRequest request);
