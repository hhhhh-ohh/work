...
public interface SystemResourceQueryProvider {
	 ...
	 */
	@PostMapping("/setting/${application.setting.version}/systemresource/init-es-page")
	BaseResponse<SystemResourcePageResponse> initEsPage(@RequestBody @Valid SystemResourcePageRequest systemResourcePageReq);
	 ...
	 *
	 * @author
	 * @return 单个查询平台素材资源最大sort值 {@link SystemResourceByIdResponse}
	 */
	@PostMapping("/setting/${application.setting.version}/systemresource/get-max-sort")
	BaseResponse<SystemResourceMaxSortResponse> getMaxSort();
