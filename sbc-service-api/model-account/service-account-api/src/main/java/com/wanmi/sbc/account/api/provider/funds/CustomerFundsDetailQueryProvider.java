...
public interface CustomerFundsDetailQueryProvider {
     ...
     */
    @PostMapping("/account/${application.account.version}/funds/detail/count")
    BaseResponse<Long> countForExport(@RequestBody @Valid CustomerFundsDetailExportRequest request);
