...
public interface SettlementProvider {
    ...
    @PostMapping("/account/${application.account.version}/finance/record/settlement/add/lakala")
    ...
    @PostMapping("/account/${application.account.version}/finance/record/settlement/delete/lakala")
    BaseResponse<LakalaSettlementGetByIdResponse> lakalaDelete(@RequestBody @Valid SettlementDeleteRequest request);
    ...
    @PostMapping("/account/${application.account.version}/finance/record/settlement/lakala-batch-modify-status")
    BaseResponse LakalabatchModifyStatus(@RequestBody @Valid LakalaSettlementBatchUpdateStatusRequest request);
}
