...
public interface AccountRecordQueryProvider {
     ...
     * @return
     */
    @PostMapping("/account/${application.account.version}/finance/reconciliation/list-by-page")
    BaseResponse<List<ReconciliationVO>> listByPage(@RequestBody @Valid BasePageRequest request);
}
