...
public interface EsDistributionCustomerProvider {
    ...
    BaseResponse init(@RequestBody EsDistributionCustomerInitRequest request);
     ...
     * @return
     */
    @PostMapping("/elastic/${application.elastic.version}/distribution-customer/modify")
    BaseResponse<EsDistributionCustomerAddResponse> modify(@RequestBody @Valid EsDistributionCustomerModifyRequest request);
