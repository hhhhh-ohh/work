...
@NoArgsConstructor
@AllArgsConstructor
public class CommunityRegionSettingQueryRequest extends BaseQueryRequest {
	 ...
	 * 模糊查询-区域名称
	 */
	@Schema(description = "模糊查询-区域名称")
	private String likeRegionName;

	/**
	 * 非区域id
	 */
	@Schema(description = "非区域id")
	private Long notRegionId;

	/**
	 * 精确查询-区域名称
	 */
	@Schema(description = "精确查询-区域名称")
