...
public interface DistributionRecordQueryProvider {
     ...
     * @author of2975
     */
    @PostMapping("/marketing/${application.marketing.version}/distributionrecord/export/count")
    BaseResponse<Long> countForExport(@RequestBody @Valid DistributionRecordExportRequest distributionRecordExportReq);
