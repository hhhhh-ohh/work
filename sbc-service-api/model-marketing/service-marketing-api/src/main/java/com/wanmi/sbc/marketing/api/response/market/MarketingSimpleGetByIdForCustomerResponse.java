...
import com.wanmi.sbc.marketing.bean.vo.MarketingSimpleVO;
...
@NoArgsConstructor
@AllArgsConstructor
public class MarketingSimpleGetByIdForCustomerResponse {

    /**
     * 终端营销视图
     */
    @Schema(description = "终端营销视图")
    private MarketingSimpleVO marketingSimpleVO;
