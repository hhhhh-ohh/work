...
import com.wanmi.sbc.marketing.api.response.bookingsale.*;
import com.wanmi.sbc.marketing.api.response.bookingsalegoods.BookingSaleInProgressAllGoodsInfoIdsResponse;
 ...
 */
@FeignClient(value = "${application.marketing.name}", contextId = "BookingSaleQueryProvider")
public interface BookingSaleQueryProvider {
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/page")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/list")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/get-by-id")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/get-one")
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/in-progress-booking-sale-info")
     ...
     * @return
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/is-in-progress")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/get-not-end-activity")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/in-progress-all-by-goods-info-ids")
     ...
     * @author dany
     */
    @PostMapping("/marketing/${application.marketing.version}/bookingsale/page-new")
