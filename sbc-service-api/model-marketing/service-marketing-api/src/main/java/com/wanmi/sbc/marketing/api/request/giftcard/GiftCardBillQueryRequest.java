...
@NoArgsConstructor
@AllArgsConstructor
public class GiftCardBillQueryRequest extends BaseQueryRequest {
	 ...
	 */
	@Schema(description = "批量查询-businessTypeList")
	private List<GiftCardBusinessType> businessTypeList;
