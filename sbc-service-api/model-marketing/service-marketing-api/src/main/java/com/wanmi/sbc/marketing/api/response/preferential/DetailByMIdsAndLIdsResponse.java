...
@NoArgsConstructor
@AllArgsConstructor
public class DetailByMIdsAndLIdsResponse extends BasicResponse {
    @Schema(description = "营销加价购详情列表")
    private List<MarketingPreferentialGoodsDetailVO> preferentialGoodsDetailVOS;
}
