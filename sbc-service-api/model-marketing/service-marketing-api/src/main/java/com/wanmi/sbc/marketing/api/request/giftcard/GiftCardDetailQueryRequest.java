...
@NoArgsConstructor
@AllArgsConstructor
public class GiftCardDetailQueryRequest extends BaseQueryRequest {
	 ...
	 * 非礼品卡详情状态列表
	 */
	@Schema(description = "非礼品卡详情状态列表")
	private List<GiftCardDetailStatus> notCardDetailStatusList;
