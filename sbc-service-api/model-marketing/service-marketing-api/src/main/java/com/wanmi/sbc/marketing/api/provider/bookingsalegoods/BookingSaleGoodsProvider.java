package com.wanmi.sbc.marketing.api.provider.bookingsalegoods;

import com.wanmi.sbc.common.base.BaseResponse;
import com.wanmi.sbc.marketing.api.request.bookingsale.BookingSaleGoodsCountRequest;
import com.wanmi.sbc.marketing.api.request.bookingsalegoods.BookingSaleGoodsAddRequest;
import com.wanmi.sbc.marketing.api.response.bookingsalegoods.BookingSaleGoodsAddResponse;
import com.wanmi.sbc.marketing.api.request.bookingsalegoods.BookingSaleGoodsModifyRequest;
import com.wanmi.sbc.marketing.api.response.bookingsalegoods.BookingSaleGoodsModifyResponse;
import com.wanmi.sbc.marketing.api.request.bookingsalegoods.BookingSaleGoodsDelByIdRequest;
import com.wanmi.sbc.marketing.api.request.bookingsalegoods.BookingSaleGoodsDelByIdListRequest;
 ...
 */
@FeignClient(value = "${application.marketing.name}", contextId = "BookingSaleGoodsProvider")
public interface BookingSaleGoodsProvider {
	 ...
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/add")
	 ...
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/modify")
	 ...
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/delete-by-id")
	 ...
	 * @return 删除结果 {@link BaseResponse}
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/delete-by-id-list")
	 ...
	 * @return
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/subCanBookingCount")
	 ...
	 * @return
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/addCanBookingCount")
	 ...
	 * @return
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/addBookingPaycount")
	 ...
	 * @return
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/addBookinghandSelCount")
	 ...
	 * @return
	 */
	@PostMapping("/marketing/${application.marketing.version}/bookingsalegoods/addBookingTailCount")
