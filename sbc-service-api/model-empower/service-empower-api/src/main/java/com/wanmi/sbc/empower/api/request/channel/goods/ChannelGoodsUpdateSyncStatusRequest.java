...
@NoArgsConstructor
@AllArgsConstructor
public class ChannelGoodsUpdateSyncStatusRequest extends BaseQueryRequest implements Serializable {
    ...
    @Schema(description = "第三方平台商品ID")
    private List<String> thirdSpuIdList;
}
