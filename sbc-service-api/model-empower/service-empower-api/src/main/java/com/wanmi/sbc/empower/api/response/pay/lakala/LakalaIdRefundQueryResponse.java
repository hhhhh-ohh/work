...
@Data
@Schema
public class LakalaIdRefundQueryResponse {
    ...
    @JSONField(alternateNames = {"out_refund_order_no", "outRefundOrderNo"})
    ...
    private List<LakalaTradeQueryResponse.SplitInfo> splitInfo;
