...
@Builder
@Schema
public class LinkedMallOrderListQueryRequest implements Serializable {

    @Schema(description = "商城内部用户id")
    @NotBlank
    private String bizUid;

    @Schema(description = "主订单号列表，最多支持20个")
    private List<String> lmOrderList;

    @Schema(description = "订单支付状态，12=待支付，2=已支付，4=已退款关闭，6=交易成功，8=被淘宝关闭")
    ...
    linkedMall商城 物流状态
        ...
        8=还未创建物流订单
     */
    @Schema(description = "订单物流状态，1=未发货，2=已发货，3=已收货， 4=已经退货， 5=部分收货， 6=部分发货中，8=还未创建物流订单")
    private Integer logisticsStatus;

    @Schema(description = "创单开始时间戳")
    private Long createBeginTime;

    @Schema(description = "创单结束时间戳")
    private Long createEndTime;

    @Schema(description = "订单状态，0：生效，1：无效, -1：都查，不填默认为-1")
    private Integer enableStatus;

    @Schema(description = "当前页码，从1开始")
    private Long pageNum;

    @Schema(description = "每页多少条记录,最大20条")
    private Long pageSize;

    @Schema(description = "是否全量查询")
