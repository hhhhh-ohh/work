...
@Builder
@Schema
public class ChannelTradeDTO implements Serializable {
    ...
    private List<ChannelTradeItemDTO> tradeItems;
    ...
    private List<ChannelTradeItemDTO> gifts;


    /**
     * 加价购商品列表
     */
    private List<ChannelTradeItemDTO> preferential = new ArrayList<>();
