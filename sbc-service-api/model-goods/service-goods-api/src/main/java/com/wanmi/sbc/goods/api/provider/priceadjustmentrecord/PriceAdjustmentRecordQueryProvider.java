...
public interface PriceAdjustmentRecordQueryProvider {
	 ...
	 * @param request 指定时间范围请求
	 * @return PriceAdjustmentRecordListResponse
	 */
	@PostMapping("/goods/${application.goods.version}/price-adjustment-record/will-effective-list")
	BaseResponse<PriceAdjustmentRecordListResponse> willEffectiveList(@RequestBody @Valid PriceAdjustmentRecordWillEffectiveListRequest request);
