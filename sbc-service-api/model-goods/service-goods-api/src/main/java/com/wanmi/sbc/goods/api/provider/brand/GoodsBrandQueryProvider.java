...
public interface GoodsBrandQueryProvider {
     ...
     * @return 品牌列表 {@link GoodsBrandListResponse}
     */
    @PostMapping("/goods/${application.goods.version}/brand/center-list")
    BaseResponse<GoodsBrandListResponse> center(@RequestBody @Valid GoodsBrandListRequest request);
     ...
     * 查询存在品牌名称列表
     *
     * @param request {@link GoodsBrandNamesExistRequest}
     * @return 出参 {@link GoodsBrandNameExistResponse}
     */
    @PostMapping("/goods/${application.goods.version}/brand/exist-brand-names")
    BaseResponse<GoodsBrandNameExistResponse> queryExistBrandNames(@RequestBody @Valid GoodsBrandNamesExistRequest request);

    /**
     * 查询存在品牌别名称列表
     *
     * @param request {@link GoodsBrandNickNamesExistRequest}
     * @return 出参 {@link GoodsBrandNameExistResponse}
     */
    @PostMapping("/goods/${application.goods.version}/brand/exist-brand-nick-names")
    BaseResponse<GoodsBrandNameExistResponse> queryExistNickNames(@RequestBody @Valid GoodsBrandNickNamesExistRequest request);
