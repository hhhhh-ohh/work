...
public interface GrouponGoodsInfoSaveProvider {
	...
	/**
	 * 关闭拼团活动商品
	 * @param request 关闭拼团活动商品请求对象 {@link GrouponGoodsInfoCloseRequest}
	 * @return {@link BaseResponse}
	 */
	@PostMapping("/goods/${application.goods.version}/groupon/goodsinfo/close")
	BaseResponse close(@RequestBody @Valid GrouponGoodsInfoCloseRequest request);
}
