...
public interface StoreCateGoodsRelaQueryProvider {
     ...
     * 统计数量
     *
     * @param request 请求入参 {@link StoreCateGoodsRelaCountRequest }
     * @return 响应结果  {@link StoreCateRelaCountResponse }
     */
    @PostMapping("/goods/${application.goods.version}/store/cate/rela/count-by-Params")
    BaseResponse<StoreCateRelaCountResponse> countByParams(@RequestBody @Valid StoreCateGoodsRelaCountRequest request);
}
