...
public interface GoodsEvaluateSaveProvider {
	 ...
	 *
	 * @author liutao
	 * @param request 批量删除参数结构 {@link GoodsEvaluateModifyIsShowRequest}
	 * @return 删除结果 {@link BaseResponse}
	 */
	@PostMapping("/goods/${application.goods.version}/goodsevaluate/modify-evaluate-is-show")
	BaseResponse modifyEvaluateIsShow(@RequestBody @Valid GoodsEvaluateModifyIsShowRequest request);
