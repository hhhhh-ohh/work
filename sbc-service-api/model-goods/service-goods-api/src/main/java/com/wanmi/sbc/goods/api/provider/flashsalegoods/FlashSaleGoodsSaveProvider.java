...
public interface FlashSaleGoodsSaveProvider {
	 ...
	 *
	 * @author xuyunpeng
	 * @param request 单个删除参数结构 {@link FlashSaleGoodsCloseRequest}
	 * @return 删除结果 {@link BaseResponse}
	 */
	@PostMapping("/goods/${application.goods.version}/flashsalegoods/close")
	BaseResponse close(@RequestBody @Valid FlashSaleGoodsCloseRequest request);

	/**
	 * 删除抢购活动API
	 *
	 * @author xufeng
	 * @param flashSaleGoodsDelByActivityIdRequest 删除参数结构 {@link FlashSaleGoodsDelByActivityIdRequest}
	 * @return 删除结果 {@link BaseResponse}
	 */
	@PostMapping("/goods/${application.goods.version}/flashsalegoods/delete-by-activityid")
	BaseResponse deleteByActivityId(@RequestBody @Valid FlashSaleGoodsDelByActivityIdRequest flashSaleGoodsDelByActivityIdRequest);

	/**
	 * 修改抢购商品表API
	 *
	 * @author xufeng
	 * @param flashSaleGoodsBatchModifyRequest 抢购商品参数结构 {@link FlashSaleGoodsBatchModifyRequest}
	 * @return 抢购商品表信息 {@link FlashSaleGoodsBatchModifyRequest}
	 */
	@PostMapping("/goods/${application.goods.version}/flashsalegoods/batchModify")
	BaseResponse<FlashSaleGoodsAddResponse> batchModify(@RequestBody @Valid FlashSaleGoodsBatchModifyRequest flashSaleGoodsBatchModifyRequest);
	 ...
	 * @return 新增的抢购商品表信息 {@link FlashSaleGoodsAddResponse}
	 */
	@PostMapping("/goods/${application.goods.version}/flashsalegoods/batchAddPromotion")
	BaseResponse<FlashSaleGoodsAddResponse> batchAddPromotion(@RequestBody @Valid FlashSaleGoodsBatchAddRequest flashSaleGoodsAddRequest);
