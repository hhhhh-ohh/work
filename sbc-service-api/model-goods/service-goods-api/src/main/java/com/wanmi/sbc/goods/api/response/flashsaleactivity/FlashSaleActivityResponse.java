...
@Schema
@Data
public class FlashSaleActivityResponse extends BasicResponse {
    /**
     * 活动日期
     */
    ...
    public FlashSaleActivityResponse convertFromNativeSQLResult(Object result) {
        ...
        this.setGoodsNum(StringUtil.cast(results, 3, Long.class) != null ? StringUtil.cast(results, 3,
                Long.class).intValue() : 0);
        this.setStoreNum(StringUtil.cast(results, 4, Long.class) != null ? StringUtil.cast(results, 4,
                Long.class).intValue() : 0);
        return this;
    }
}
