...
public interface GoodsCateProvider {
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/cate/set-contains-virtual")
    BaseResponse setContainsVirtual(@RequestBody @Valid GoodsCateContainsVirtualRequest request);
}
