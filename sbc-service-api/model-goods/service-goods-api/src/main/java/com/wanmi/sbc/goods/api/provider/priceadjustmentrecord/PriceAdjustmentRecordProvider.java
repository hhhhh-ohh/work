...
public interface PriceAdjustmentRecordProvider {
	...
	/**
	 * @description 根据调价单ids更新其扫描标识为已扫描
	 * @author malianfeng
	 * @date 2021/9/13 10:59
	 * @param request 调价单ids
	 * @return com.wanmi.sbc.common.base.BaseResponse
	 */
	@PostMapping("/goods/${application.goods.version}/price-adjustment-record/modify-scan-type")
	BaseResponse modifyScanType(@RequestBody @Valid PriceAdjustmentRecordModifyScanTypeRequest request);
