...
public interface GoodsInfoSiteQueryProvider {
     ...
     * @return 商品详情 {@link GoodsInfoDetailByGoodsInfoResponse }
     */
    @PostMapping("/goods/${application.goods.version}/info/get-simple-by-goods-info")
    BaseResponse<GoodsInfoSimpleDetailByGoodsInfoResponse> getSimpleByGoodsInfo(@RequestBody @Valid GoodsInfoRequest goodsInfoRequest);
