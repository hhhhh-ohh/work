...
/**
 * @author xuyunpeng
 * @className BuyCycleGoodsBySkuIdResponse
 * @description
 * @date 2022/10/17 1:52 PM
 **/
@Schema
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BuyCycleGoodsBySpuIdResponse implements Serializable {
    private static final long serialVersionUID = -2750439200670430496L;
