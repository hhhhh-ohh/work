...
public interface GrouponGoodsInfoQueryProvider {
	 ...
	 * 列表查询商品skuIds
	 */
	@PostMapping("/goods/${application.goods.version}/groupon/count-by-activity-ids-and-sku-ids")
	BaseResponse<GrouponCountByActivityIdsAndSkuIdsResponse> countByActivityIdsAndSkuIds(@RequestBody @Valid GrouponCountByActivityIdsAndSkuIdsRequest request);
}
