...
@NoArgsConstructor
@AllArgsConstructor
public class BuyCycleGoodsModifyRequest extends BaseRequest {

	private static final long serialVersionUID = 6393079241755097017L;
	...
	@NotEmpty
	private List<BuyCycleGoodsInfoModifyRequest> buyCycleGoodsInfoModifyRequests;
