...
import com.wanmi.sbc.crm.api.request.customgroup.*;
...
public interface CustomGroupProvider {
    ...
    @PostMapping("/crm/${application.crm.version}/customgroup/importSystemLifeCycleGroup")
    BaseResponse importSystemLifeCycleGroup(@RequestBody CustomGroupRequest request);

    @PostMapping("/crm/${application.crm.version}/customgroup/batchSort")
