...
@Builder
@Schema
public class ChannelOrderVO extends BasicResponse {
    ...
    private ChannelOrderStateVO tradeState;

    /**
     * 收货人信息
     */
    @Schema(description = "收货人信息")
    private ChannelConsigneeVO consignee;

    /**
     * 订单价格
     */
    @Schema(description = "渠道价格")
    private ChannelOrderPriceVO tradePrice;
    ...
    private List<ChannelOrderItemVO> tradeItems;
    ...
    private List<ChannelOrderItemVO> gifts;

    @Schema(description = "营销加价购全量列表")
    private List<ChannelOrderItemVO> preferential = new ArrayList<>();
