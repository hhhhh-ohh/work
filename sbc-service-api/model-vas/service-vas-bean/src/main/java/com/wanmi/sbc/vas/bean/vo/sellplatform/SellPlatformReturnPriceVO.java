...
@Builder
@Schema
public class SellPlatformReturnPriceVO implements Serializable {
     ...
     * @return
     */
    public DiffResult<SellPlatformReturnPriceVO> diff(SellPlatformReturnPriceVO returnPrice){
     ...
     * @param newPrice
     */
    public void merge(SellPlatformReturnPriceVO newPrice){
        DiffResult<SellPlatformReturnPriceVO> diffResult = this.diff(newPrice);
    ...
    private void mergeSimple(String fieldName, Object right){
        Field field = ReflectionUtils.findField(SellPlatformReturnPriceVO.class, fieldName);
        try {
            field.setAccessible(true);
            field.set(this, right);
        } catch (IllegalAccessException e) {
            throw new SbcRuntimeException(OrderErrorCodeEnum.K050023, new Object[]{SellPlatformReturnPriceVO.class, fieldName });
        }
    }
     ...
     * @return
     */
    public List<String> buildDiffStr(SellPlatformReturnPriceVO price){
        ...
        DiffResult<SellPlatformReturnPriceVO> diffResult = this.diff(price);
