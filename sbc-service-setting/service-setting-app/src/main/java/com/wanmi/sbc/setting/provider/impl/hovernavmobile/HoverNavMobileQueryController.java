...
public class HoverNavMobileQueryController implements HoverNavMobileQueryProvider {
	...
	@Override
	public BaseResponse<BottomNavMobileByIdResponse> getBottomNavById(@Valid BottomNavMobileByIdRequest bottomNavMobileByIdRequest) {
		HoverNavMobile hoverNavMobile = hoverNavMobileService.getOne(bottomNavMobileByIdRequest.getStoreId());
		return BaseResponse.success(new BottomNavMobileByIdResponse(hoverNavMobileService.wrapperBottomVo(hoverNavMobile)));
	}
}
