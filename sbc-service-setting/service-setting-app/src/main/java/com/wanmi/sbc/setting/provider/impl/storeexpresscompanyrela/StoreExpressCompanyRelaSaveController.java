...
public class StoreExpressCompanyRelaSaveController implements StoreExpressCompanyRelaSaveProvider {
	...
	@Override
	public BaseResponse deleteByExpressCompanyId(@RequestBody @Valid StoreExpressCompanyRelaDelByExpressCompanyIdRequest request) {
		storeExpressCompanyRelaService.deleteByExpressCompanyId(request.getExpressCompanyId());
		return BaseResponse.SUCCESSFUL();
	}
