...
public interface AssociationLongTailWordRepossitory extends JpaRepository<AssociationLongTailWord, Long>,
     ...
     */
    @Modifying
    @Query("update AssociationLongTailWord set  delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where " +
     ...
     */
    @Modifying
    @Query(value = "update AssociationLongTailWord at set at.sortNumber =:sortNumber,at.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO where at" +
            ".associationLongTailWordId=:associationLongTailWordId")
     ...
     * @return
     */
    @Query("select c from AssociationLongTailWord c where c.searchAssociationalWordId = ?1 and  c.delFlag = ?2 order by c.createTime desc")
     ...
     * @return
     */
    @Query("select count(1) from AssociationLongTailWord c where c.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO and c.associationLongTailWordId <> ?1 and c" +
