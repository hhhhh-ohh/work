...
public interface ExpressCompanyRepository extends JpaRepository<ExpressCompany, Long>,
     ...
     * 根据物流公司代码查询
     * @author wur
     * @param expressCode  物流公司代码查询
     * @param delFlag   删除标识
     * @return             物流信息
     */
    ExpressCompany findExpressCompanyByExpressCodeAndDelFlag(String expressCode, DeleteFlag delFlag);
     ...
     */
    @Modifying
    @Query("update ExpressCompany set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where expressCompanyId = ?1")
     ...
     */
    @Modifying
    @Query("update ExpressCompany set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where expressCompanyId in ?1")
     ...
     * @author bail
     */
    @Query("select count(1) from ExpressCompany l where l.delFlag = com.wanmi.sbc.common.enums.DeleteFlag.NO ")
