...
public interface OperateDataLogRepository extends JpaRepository<OperateDataLog, Long>,
     ...
     */
    @Modifying
    @Query("update OperateDataLog set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where id = ?1")
     ...
     */
    @Modifying
    @Query("update OperateDataLog set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where id in ?1")
    int deleteByIdList(List<Long> idList);

    @Modifying
    @Query("update OperateDataLog set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where operateId = ?1")
