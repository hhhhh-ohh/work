...
public class SystemPrivacyPolicyService {
     ...
     * @return
     */
    public SystemPrivacyPolicy querySystemPrivacyPolicy(PrivacyType type) {
        SystemPrivacyPolicy config = systemPrivacyPolicyRepository.findByPrivacyTypeAndDelFlag(type,DeleteFlag.NO);
        return config;
    }
