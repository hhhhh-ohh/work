...
public class PopupAdministrationService {
    ...
    public PopupAdministration modify(PopupAdministrationModifyRequest request) {
        PopupAdministration popupAdministration =
                popupAdministrationRepository.findById(request.getPopupId()).orElseThrow(() -> new SbcRuntimeException(SettingErrorCodeEnum.K070079));
    ...
    public int deletePopupAdministration(Long popupAdministrationId) {
        PopupAdministration popupAdministration =
                popupAdministrationRepository.findById(popupAdministrationId).orElseThrow(() -> new SbcRuntimeException(SettingErrorCodeEnum.K070079));
    ...
    public MicroServicePage<PopupAdministrationVO> page(PopupAdministrationPageRequest request) {
        ...
        query.unwrap(NativeQuery.class).addEntity("t", PopupAdministration.class);
    ...
    public PopupAdministration getPopupAdministrationById(Long PopupAdministrationId) {
        return popupAdministrationRepository.findById(PopupAdministrationId).orElseThrow(() -> new SbcRuntimeException(SettingErrorCodeEnum.K070079));
    }
