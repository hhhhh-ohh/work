...
public class PointsBasicRuleService {
    ...
    public void modifyPointsBasicRule(List<PointsBasicRuleDTO> pointsBasicRuleDTOS) {
        ...
        if(GrowthValueRule.SYNCHRONIZE_POINTS == configs.get(0).getRule()){
            ...
            growthValueBasicRules.forEach(growthValueBasicRule -> configRepository
                    .updateStatusByTypeAndConfigKey(growthValueBasicRule.getConfigType(),
                            growthValueBasicRule.getConfigKey(), growthValueBasicRule.getStatus(),
