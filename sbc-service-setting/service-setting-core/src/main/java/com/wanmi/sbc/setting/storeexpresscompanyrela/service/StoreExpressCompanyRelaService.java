...
public class StoreExpressCompanyRelaService {
	 ...
	 * @description
	 * @author  wur
	 * @date: 2021/11/9 17:20
	 * @param expressCompanyId  物流公司Id
	 * @return
	 **/
	@Transactional
	public void deleteByExpressCompanyId(Long expressCompanyId) {
		storeExpressCompanyRelaRepository.deleteByExpressCompanyId(expressCompanyId);
	}
