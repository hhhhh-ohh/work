...
public interface PopupAdministrationRepository extends JpaRepository<PopupAdministration,Long>,
     ...
     */
    @Modifying
    @Query("update PopupAdministration set delFlag = com.wanmi.sbc.common.enums.DeleteFlag.YES where popupId = :popupId")
     ...
     */
    @Modifying
    @Query("update PopupAdministration set isPause = com.wanmi.sbc.common.enums.BoolFlag.YES where popupId = :popupId")
     ...
     */
    @Modifying
    @Query("update PopupAdministration set isPause = com.wanmi.sbc.common.enums.BoolFlag.NO where popupId = :popupId")
