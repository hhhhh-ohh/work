...
//                if (aField != null && aField.getAnnotated() != null) {
...
//        Enum<?>[] clazzEnumConstants = clazz.getEnumConstants();
//        List<String> lines = new ArrayList<>(clazzEnumConstants.length);
//        boolean foundAny = false;
//        for (Enum<?> enumVal : clazzEnumConstants) {
...
//        return annotation -> {
//            try {
//                return resolver.resolve(getClassType(annotation));
//            } catch (ClassNotFoundException e) {
...
//        return annotation -> {
//            try {
//                return resolver.arrayType(getClassType(annotation));
//            } catch (ClassNotFoundException e) {
...
//    }
//
//    private static Class<?> getClassType(ApiEnum apiEnum) throws ClassNotFoundException {
//        if(apiEnum.classType()!=Exception.class){
//            return apiEnum.classType();
//        }else{
//            return Class.forName(apiEnum.dataType());
//        }
//    }
//}