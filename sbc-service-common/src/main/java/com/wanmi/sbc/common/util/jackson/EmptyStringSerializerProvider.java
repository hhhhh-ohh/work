package com.wanmi.sbc.common.util.jackson;
...
public class EmptyStringSerializerProvider extends DefaultSerializerProvider {
    ...
    @Override
    public EmptyStringSerializerProvider withCaches(CacheProvider cacheProvider) {
        return new EmptyStringSerializerProvider(this, _config, _serializerFactory);
    }
