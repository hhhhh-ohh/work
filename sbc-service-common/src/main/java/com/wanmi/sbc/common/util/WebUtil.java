...
public class WebUtil {
    ...
    public static String appendQueryParams(String url, Map<String, String> params) throws IOException {
        ...
        if (params != null) {
            ...
            for (Map.Entry<String, String> param : params.entrySet()) {
                ...
                fullUrl.append(URLEncoder.encode(param.getKey(), DEFAULT_CHARSET))
                        .append('=')
                        .append(URLEncoder.encode(param.getValue(), DEFAULT_CHARSET));
            }
        }
    ...
    public static Map<String, String> getQueryParams(String url) throws IOException {
        Map<String, String> params = new HashMap<String, String>(StringUtils.countMatches(url, '&') + 1);
    ...
    public static String fetch(String method, String url, String body, Map<String, String> headers) throws IOException {
        ...
        try {
            ...
            String response = streamToString1(is);
            is.close();
    ...
    public static String streamToString1(InputStream inputStream) throws IOException{
        StringBuilder stringBuilder = new StringBuilder();
        if (inputStream != null) {
            try (// 此处需要将编码格式设置为UTF_8，解决 InputStream 流读取时的中文乱码问题
                ...
                log.error("WebUtil => fetch => streamToString is error, msg: ", ex);
            }
        }
    ...
    public static boolean isImage(String url) {
        ...
        try {
            ...
            log.error("验证是否是图片IO异常", e);
            return false;
        } catch (Exception e) {
            log.error("验证是否是图片异常", e);
            return false;
        } finally {
            if (is != null) {
                try {
