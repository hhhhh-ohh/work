...
public final class ErrorCodeConstant {
     ...
     * 秒杀商品抢购活动被关闭
     */
    public static final String FLASH_SALE_ACTIVITY_CLOSED = "K-140010";

    /**
     * 秒杀商品抢购活动库存不足
     */
    public static final String FLASH_SALE_ACTIVITY_UNDER_STOCK = "K-140011";
     ...
     * 退款回调业务改造---退款回调结果已存在
     */
    public static final String REFUND_CALL_BACK_RESULT_EXIT = "K-069999";

    /**
     * 当前发货状态已发生变化，请刷新页面查看更新
     */
    public static final String K_050315 = "K-050315";

    public static final String K_050314 = "K-050314";

    /**
     * 二维码已失效。请刷新页面重试
     */
    public static final String K_010218 = "K-010218";
