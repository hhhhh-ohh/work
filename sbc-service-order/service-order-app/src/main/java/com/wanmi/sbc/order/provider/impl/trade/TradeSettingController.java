...
public class TradeSettingController implements TradeSettingProvider {
    ...
    @Override
    public BaseResponse orderAutoReceiveSendMiniProgramMsg() {
        tradeSettingService.orderAutoReceiveSendMiniProgramMsg();
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse modifyOrderPerformanceAutoSettle() {
        tradeSettingService.orderPerformanceAutoSettle();
        return BaseResponse.SUCCESSFUL();
    }
}
