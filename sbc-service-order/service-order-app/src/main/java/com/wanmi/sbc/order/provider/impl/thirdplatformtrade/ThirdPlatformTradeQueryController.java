...
public class ThirdPlatformTradeQueryController implements ThirdPlatformTradeQueryProvider {
     ...
     */
    @Override
    public BaseResponse<ThirdPlatformTradeByThirdPlatformOrderIdResponse> queryByThirdPlatformOrderId(@RequestBody @Valid ThirdPlatformTradeByThirdPlatformOrderIdRequest request) {
        ThirdPlatformTradeByThirdPlatformOrderIdResponse response = new ThirdPlatformTradeByThirdPlatformOrderIdResponse();
        ThirdPlatformTradeQueryRequest tradeQueryRequest = new ThirdPlatformTradeQueryRequest();
        tradeQueryRequest.setThirdPlatformType(request.getThirdPlatformType());
        tradeQueryRequest.setThirdPlatformOrderId(request.getThirdPlatformOrderId());
        ThirdPlatformTrade thirdPlatformTrade = thirdPlatformTradeService.queryByThirdPlatformOrderId(tradeQueryRequest);
        ThirdPlatformTradeVO thirdPlatformTradeVO = KsBeanUtil.convert(thirdPlatformTrade, ThirdPlatformTradeVO.class);
        response.setThirdPlatformTradeVO(thirdPlatformTradeVO);
