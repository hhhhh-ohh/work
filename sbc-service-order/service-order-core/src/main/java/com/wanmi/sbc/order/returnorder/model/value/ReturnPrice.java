...
public class ReturnPrice {
     ...
     * @return
     */
    public DiffResult<ReturnPrice> diff(ReturnPrice returnPrice) {
    ...
    public void merge(ReturnPrice newPrice) {
        DiffResult<ReturnPrice> diffResult = this.diff(newPrice);
    ...
    private void mergeSimple(String fieldName, Object right) {
        ...
        try {
            ...
            throw new SbcRuntimeException(OrderErrorCodeEnum.K050023, new Object[]{ReturnPrice.class, fieldName});
        }
    }
    ...
    public List<String> buildDiffStr(ReturnPrice price) {
        ...
        DiffResult<ReturnPrice> diffResult = this.diff(price);
