...
public class RefundBillService {
    ...
    public void save(RefundBillAddRequest refundBillRequest) {
        ...
        Optional<RefundOrder> refundOrderResult = refundOrderService.findById(refundBillRequest.getRefundId());
        refundOrderResult.ifPresent(refundOrder ->
    ...
    public Optional<RefundBill> save(RefundBill refundBill) {
        ...
        return Optional.of(refundBillRepository.save(refundBill));
    }

    @Transactional
    public Optional<RefundBill> saveAndFlush(RefundBill refundBill) {
        return Optional.of(refundBillRepository.saveAndFlush(refundBill));
    }
