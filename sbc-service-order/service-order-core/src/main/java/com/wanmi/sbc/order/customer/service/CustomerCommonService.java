...
public class CustomerCommonService {
    ...
    public CustomerDetailVO getAnyCustomerDetailById(String customerDetailId) {
        return customerDetailQueryProvider.listCustomerDetailByCondition(
                ...
                ().getCustomerDetailVOList().stream().findFirst().orElse(null);
    }
    ...
    public CustomerVO getCustomerById(String customerId) {
        return customerQueryProvider.getCustomerById(
                CustomerGetByIdRequest.builder().customerId(customerId).build()).getContext();
    }
}
