 ...
 */
public class RefundCallBackResultWhereCriteriaBuilder {
    public static Specification<RefundCallBackResult> build(RefundCallBackResultQueryRequest queryRequest) {
