...
public class ReturnPoints {
     ...
     * @return
     */
    public DiffResult<ReturnPoints> diff(ReturnPoints returnPoints) {
    ...
    public void merge(ReturnPoints newPoints) {
        DiffResult<ReturnPoints> diffResult = this.diff(newPoints);
    ...
    private void mergeSimple(String fieldName, Object right) {
        ...
        try {
            ...
            throw new SbcRuntimeException(OrderErrorCodeEnum.K050023, new Object[]{ReturnPoints.class, fieldName});
        }
    }
    ...
    public List<String> buildDiffStr(ReturnPoints Points) {
        ...
        DiffResult<ReturnPoints> diffResult = this.diff(Points);
