 ...
 */
public class PayingMemberRecordWhereCriteriaBuilder {
    public static Specification<PayingMemberRecord> build(PayingMemberRecordQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            // 已优惠金额
            if (queryRequest.getAlreadyDiscountAmount() != null) {
                predicates.add(cbuild.equal(root.get("alreadyDiscountAmount"), queryRequest.getAlreadyDiscountAmount()));
            }

            // 已领积分
            if (queryRequest.getAlreadyReceivePoint() != null) {
                predicates.add(cbuild.equal(root.get("alreadyReceivePoint"), queryRequest.getAlreadyReceivePoint()));
            }

            // 退款金额
            if (queryRequest.getReturnAmount() != null) {
                predicates.add(cbuild.equal(root.get("returnAmount"), queryRequest.getReturnAmount()));
            }

            // 退款回收券 0.是，1.否
            if (queryRequest.getReturnCoupon() != null) {
                predicates.add(cbuild.equal(root.get("returnCoupon"), queryRequest.getReturnCoupon()));
            }

            // 退款回收积分 0.是，1.否
            if (queryRequest.getReturnPoint() != null) {
                predicates.add(cbuild.equal(root.get("returnPoint"), queryRequest.getReturnPoint()));
            }
            ...
            // 首次开通 0.是，1.否
            if (queryRequest.getFirstOpen() != null) {
                predicates.add(cbuild.equal(root.get("firstOpen"), queryRequest.getFirstOpen()));
            }
